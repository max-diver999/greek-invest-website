...
Four risks recur in the Peloponnese and none of them is about price. Rural title and boundaries top the list, followed by the Golden Visa short-term rental ban removing the obvious income strategy, thin winter tenant demand outside Kalamata and Nafplio, and resale liquidity that depends heavily on the motorway rather than the view.

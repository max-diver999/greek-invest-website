...
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/greece/heroes/athens-property-investment-guide-e8beed23.webp"
heroAlt: "Athens lit up at dusk with the Acropolis in the centre"
relatedSlugs:
...
faq:
  ...
  - question: "What rental yield can you earn from Athens property?"
    answer: "Athens averages 5.43% gross rental yield city-wide, among the highest of Greece's major urban markets. Long-term residential lets in yield-positive districts such as Kipseli can reach 6 to 7.5% gross on one-bedroom stock. Three-bedroom stock, the size class a Golden Visa property must be in, runs closer to 3.8%. Riviera properties deliver slightly lower percentage yields because prices are higher relative to rents, but they carry stronger capital appreciation drivers through the Ellinikon regeneration. Net yields after ENFIA, management, maintenance, and income tax run 1 to 1.5 percentage points below gross figures."
  ...
  - question: "Can you run Airbnb on an Athens investment property in 2026?"
    answer: "It depends on the property and your visa status. Golden Visa qualifying assets cannot be used for short-term tourist rentals under any circumstances. Separately, the Athens municipality STR moratorium freezes new ΑΜΑ short-term rental licences in saturated central districts through end-2026, though grandfathered licences continue. Suburbs outside the moratorium zone, such as Glyfada or Kifisia, follow standard national STR rules, but a Golden Visa buyer still cannot STR the qualifying property itself."
...
Kipseli is the yield standout within the centre. Long-term residential lets in well-located Kipseli one-bedroom apartments can deliver 6 to 7.5% gross, well above the 5.43% city-wide average, because rents are strong relative to purchase prices in a district that has not fully repriced to Kolonaki levels. For a pure income investor who does not need a prestige address, Kipseli is one of the clearest yield-positive pockets in central Athens.
...
The short-term rental ban on the qualifying Golden Visa property is national and permanent for the duration of the permit. It is separate from the Athens municipality STR moratorium, which affects non-GV investors in central districts as well. A Golden Visa holder who buys in Koukaki cannot STR the qualifying apartment even if a grandfathered ΑΜΑ licence existed before the moratorium, the GV ban takes precedence on the residency asset.
...
Rental strategy in Athens is shaped by three overlapping rules: national Golden Visa restrictions, the Athens municipality STR moratorium, and standard ΑΜΑ licensing for tourist lets. Conflating them is one of the most expensive mistakes a new investor can make.
...
Athens city-wide gross yield averages 5.43%. In districts such as Kipseli, well-located one-bedroom apartments can reach 6 to 7.5% gross on long-term residential tenancies. The three-bedroom class runs closer to 3.8%, which is the class a Golden Visa purchase falls into. Net yields after ENFIA property tax, management fees of roughly 8 to 12% of rent, maintenance, insurance, and progressive income tax starting at 15% land 1 to 1.5 percentage points below gross. A 6.5% gross Kipseli yield realistically becomes a 5.0 to 5.5% net yield, still competitive with Western European capitals.
...
|---|---|---|---|
| Long-term residential | GV investors, centre buyers, yield focus | 5.43% city-wide; 6 to 7.5% Kipseli 1-bed, ~3.8% 3-bed | Legal everywhere |
...
Athens due diligence divides cleanly into what you do before the offer and what you do before the deed, and the ordering matters more than the list. Everything in the pre-offer group is cheap, fast and capable of ending the conversation; everything after it costs money and assumes the property is real.
### Pre-offer checks
...
4. For centre apartments, confirm ΑΜΑ STR licence status and whether the unit falls inside the moratorium zone.
...
14. If the property has a grandfathered STR licence, transfer the ΑΜΑ registration promptly after completion.
...
| Kipseli LTR yields 6 to 7.5% on one-bedroom stock | GV qualifying asset cannot be used for Airbnb |
...
If you do not need a Golden Visa, Athens is usually the better buy: the centre delivers 6% to 7.5% gross on stock priced between €1,200 and €2,000 per square metre, which regional Greece rarely matches with the same tenant depth. If you do need one, the €800,000 Attica threshold is the whole argument, and Crete or the Peloponnese at €400,000 will buy twice the floor area for half the capital.
...
**Planning an Attica purchase specifically?** The [invest in Athens property page](/invest-athens-property/) sets out the €800,000 tier against submarket yields, the 120 m² problem in compact urban stock, and the full cost stack on an €800,000 purchase.

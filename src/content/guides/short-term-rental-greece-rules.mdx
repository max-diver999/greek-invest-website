...
description: "Athens and Thessaloniki registration freezes, the Golden Visa STR ban, licensing steps, and what Cretan short lets actually earn."
pubDate: 2026-06-17
...
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/w_1200,q_85,f_webp/more-group/greece/wikimedia-hero/plaka-athens-neighbourhood-3c7e3991"
relatedSlugs:
...
faq:
  ...
  - question: "What rental yield can I expect from licensed STR in Crete?"
    answer: "Licensed STR operators in tourist-facing Crete locations, Chania, Heraklion waterfront, Elounda, Rethymno, report gross yields of a higher figure on purchase price. The operational season concentrates from May to October. Management and OTA fees of 18 to 25%, Greek rental income tax (15 to 35%), ENFIA property tax, and maintenance compress net yields to approximately 4 to 6% after all expenses."
...
**Quick answer:** Short-term rental in Greece is legal but requires a MITA registry number from AADE before accepting any booking. Athens city centre is under a new-licence moratorium through end-2026, no new registrations inside the zone. Golden Visa properties are banned from STR entirely under Law 4959/2022. Outside these two restrictions, licensed operators, particularly in Crete, achieve gross yields of higher gross revenue, compressing to 4 to 6% net after management fees, OTA commissions, and Greek rental income tax.

<TldrBlock text="STR in Greece requires a MITA registration. Athens centre: moratorium on new licences through end-2026. Golden Visa properties: STR banned by law under Law 4959/2022. Crete licensed STR: higher gross revenue, 4 to 6% net. Operating without a licence risks fines from €5,000 plus AADE tax enforcement." />
...
The threshold is thirty consecutive days. Any letting shorter than that to tourists is short-term tourist rental under Greek law, whether you advertise on Airbnb, Booking.com, a local agency or a WhatsApp group, and whether the guest pays in cash or by card. Each unit needs its own registry number, displayed on every listing. Operating without one exposes the owner to fines under Greek tourism law, and the platforms report bookings regardless of what is declared.

Every property let short-term in Greece needs its own ΑΜΑ registration number, obtained through the AADE short-term rental registry using TAXISnet credentials, and that number must appear on every platform listing. One property, one ΑΜΑ: an owner with three units needs three. Registration requires the title deed or lease, the owner's identification, the AFM, and a declaration of compliance with the Law 5170/2025 safety standards that took effect on 1 October 2025. Operating without a valid registration, or failing the standards, is charged at €5,000 to €20,000, with inspections carried out by joint teams from the Ministry of Tourism and the Independent Authority for Public Revenue whose visit also functions as a tax audit. None of this is available on a Golden Visa qualifying deed, where short-term letting is prohibited outright.
...
|---|---|---|
| 1 | Gather all required documents | 1 to 4 weeks (longer if title needs updating) |
| 2 | Submit application via myAADE portal | Same day |
| 3 | AADE processes application | 1 to 3 working days |
...
These are two different kinds of restriction and they should not be confused. The Athens moratorium is a regional measure with a stated end date. The Golden Visa prohibition is national, permanent for the life of the permit, and written into the investment-residency legislation itself. It applies wherever the property sits, has no expiry, and breaching it puts renewal at risk rather than merely attracting a fine.
...
## Crete: Licensed STR Generating higher gross revenue Gross Yields


Crete is where licensed short-term rental still works cleanly: there is no municipal moratorium, new registrations proceed under the standard national process, and a six-month season supports gross yields of higher gross revenue. The condition is that the property sits outside the Golden Visa perimeter. Buyers who want both residency and holiday income need two properties, because those higher gross revenue figures are unavailable on a qualifying asset at any location.
...
No per-location yield series is published for Crete, and this page no longer prints one. What
is measured is island-level, and it is worth more than a table of invented precision.

| Crete, measured | Figure |
|---|---:|
| Active listings | 33,148 |
| Average annual revenue per listing | about $16,100 |
| Occupancy | 62% |
| Average daily rate | $237 |

Source: AirDNA market data as reported July 2026. Revenue is gross booking revenue before
platform commission, management, cleaning, utilities and tax.

**Why this is not a yield.** Revenue is published per listing; prices are published per
square metre. Turning one into the other needs the floor area of the unit, which the data
does not pair with the revenue. On Cretan asking prices the same $16,100 implies about 14%
on a 45 m² studio and about 4.6% on a 140 m² house. Any single STR yield percentage you are
quoted has silently chosen a unit size for you, and the number moves by a factor of three
depending on which one it chose.

The relative ordering across the island is not in doubt: Chania old town and the Elounda
strip out-earn Heraklion and Rethymno, and the Lasithi interior trails all of them. The
ordering is useful. The decimal places were not.

*Gross yield = annual gross rental revenue divided by purchase price. Net yield = gross revenue minus OTA/management fees (18 to 25%), Greek rental income tax (15 to 35%), ENFIA, maintenance, and vacancy. Source: property management company disclosures and AADE income declaration data 2024 to 2025.*
...
- **Management and OTA commissions**: 18 to 25% of gross revenue, covering property management, channel management, cleaning between stays, and guest communications
- **Greek rental income tax**: 15% on the first €12,000 of annual rental income, 25% on €12,001 to €24,000, 35% on €24,001 to €35,000 and 45% above that

After correctly stacking these expenses, a Crete STR unit with 9% gross yield typically nets 4 to 5.5%, a strong result by European standards, but materially different from the headline gross figures that appear in many market listings.
...
The practical downside for a GV investor who uses their qualifying property for Airbnb is disproportionate to the incremental rental income. The STR premium over long-term rental, typically 2 to 4 percentage points of yield, is not remotely worth the residency revocation risk.
...
The 2026 rules force a choice rather than a compromise. If short-term income is the primary objective, buy outside the Athens moratorium zone under a non-Golden-Visa structure, complete registration before the first booking, and model net yields at 4% to 6% after 30% to 40% combined management and platform costs. If residency is the objective, model twelve-month leases only. Trying to serve both objectives with one property is the mistake this framework exists to prevent.
...
## Risks and red flags for short-term rental operators


Four rules catch owners who assume Greece works like their home market: the Golden Visa ban is absolute on the qualifying asset for the life of the permit, every unit needs its own ΑΜΑ registration displayed on the listing, central Athens is under a moratorium on new licences through 31 December 2026, and Law 5170/2025 added safety and insurance standards that carry fines up to €20,000 for repeat non-compliance.
Four rules catch owners who model Greek short-term rental on a foreign market.

- **The Golden Visa ban is absolute on the qualifying asset.** It applies for the life of the permit, and letting the property short-term puts renewal at risk. If short-term income matters, the qualifying property is the wrong asset for it.
- **Registration is not optional.** Each unit needs its own registry number, displayed on every listing. Operating without it exposes the owner to fines under Greek tourism law.
- **The Athens centre moratorium.** New short-term rental registrations are restricted in central Athens districts through the end of 2026. A property bought on short-term projections may not be licensable at all.
- **Tax treatment.** Short-term rental income enters the same progressive bands as long-let income, at 15% to 45%, and platform reporting means the revenue is visible to AADE regardless of what is declared.

## Law 5170/2025: The Property Standards That Took Effect on 1 October 2025

Registration is no longer enough. Since 1 October 2025 every short-term rental unit in Greece has had to meet a set of physical and insurance standards, and non-compliance is charged at €5,000 to €20,000 rather than remedied with a warning. Inspections are carried out by joint teams from the Ministry of Tourism and the Independent Authority for Public Revenue, and the same visit doubles as a tax audit.

| Requirement | What the law asks for |
| --- | --- |
| Registration | Valid ΑΜΑ number, displayed on every platform listing |
| Use classification | The unit must be a main-use space (κύρια χρήση), not a basement, storeroom or converted auxiliary area |
| Natural light | Bedroom window area of at least 10% of the room's floor area |
| Ventilation | Openable area of at least 5% of the bedroom's floor area |
| Climate control | Working air conditioning |
| Fire equipment | Fire extinguisher of at least 6 kg, 21A-113B-C class, per 100 m² |
| Detection | Independent smoke detectors in bedrooms and kitchen |
| Electrical safety | Residual current device (anti-shock circuit breaker) on the installation |
| Emergency provision | Emergency lighting, exit signage and a first-aid kit |
| Insurance | Civil liability cover for injury or damage to guests |

### What this means for a foreign buyer

Two consequences matter at the point of purchase rather than afterwards.

The first is that a lot of older stock cannot be brought into compliance cheaply. Basement and semi-basement studios classified as auxiliary space are excluded outright, and a bedroom with a small window in a 1970s block may not reach the 10% natural-light threshold without altering the façade, which is a permit matter rather than a renovation one. If short-term income is the thesis, have the engineer check light, ventilation and use classification during the survey, not after the deed.

The second is that the existing licence you are buying is not a warranty of compliance. An ΑΜΑ issued before October 2025 says the property was registered, not that it meets the current standards. Ask for evidence of the fire equipment, the RCD and the liability policy, and price the gap if it is not there.

None of this applies to a Golden Visa qualifying asset, for the simple reason that the asset cannot be short-let at all.

<FaqBlock items={[
  {
    question: "What are the short-term rental rules in Greece in 2026?",
    answer: "All STR properties in Greece must hold a MITA registry number from AADE before accepting any booking. Athens city centre operates under a new-licence moratorium through end-2026, no new registrations inside the zone. Golden Visa qualifying properties are banned from STR entirely under Law 4959/2022. Outside these restrictions, licensed STR is legal and active, with Crete licensed operators achieving gross yields of higher gross revenue."
  },
  {
    question: "Is Airbnb legal in Greece?",
  ...
  {
    question: "What rental yield can I expect from licensed STR in Crete?",
    answer: "Licensed STR operators in tourist-facing Crete locations, Chania, Heraklion waterfront, Elounda, Rethymno, achieve gross yields of a higher figure on purchase price. The season runs May to October. Management and OTA fees of 18 to 25%, Greek rental income tax (15 to 35%), ENFIA, and maintenance compress net yields to approximately 4 to 6% after all expenses. Inland and lower-traffic areas generate lower gross yields of 5 to 7%."
  },
  {
    question: "What documents do I need for a Greece STR licence?",
    answer: "MITA registration requires: property title deed, ENFIA clearance certificate, building permit or pre-1983 regularisation certificate, architectural floor plan, fire safety certificate for properties over 80 sqm, AFM (Greek tax number), Greek bank account, and certified translations of your identity documents. The application is submitted through the AADE myAADE digital portal and processes in 1 to 3 working days once documents are complete."
  },
  {
    question: "What are the fines for unlicensed STR in Greece?",

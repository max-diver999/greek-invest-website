...
Foreign real estate inflows into Greece fell 25.3% in 2025 while domestic transaction volumes held, and the two facts together describe a compositional shift rather than a market in retreat. The largest single cause is Law 5100/2024, which raised the Golden Visa thresholds to €800,000 in Attica and €400,000 regionally and removed the €250,000 studio buyer who had driven a large share of foreign transaction count at low ticket size. Golden Visa approvals rose 95% to 8,879 over the same period, which reflects backlog clearance rather than new demand, while applications fell 24.8% to 6,978. For a buyer entering in 2026, a market with fewer competing foreign bidders and unchanged domestic depth is a better negotiating position than 2023 offered, particularly at the €400,000 tier.
...
For investors primarily focused on yield rather than residency, the [Greece rental yield guide](/guides/greece-rental-yield-guide/) sets out gross yield benchmarks by city and property type, including the higher gross revenue figures for licensed Crete short-term rental properties and the 5.43% Athens average.
...
| Athens Riviera (Glyfada, Voula) | €800,000 | 3.8% to 4.5% LTR | Ellinikon price uplift, lifestyle |
| Athens working-class zones (Kipseli, Sepolia) | €800,000 | 6.0 to 7.5% on 1-bed, not on a 120m² deed | Yield focus, lower entry within zone |
| Thessaloniki (municipality) | €800,000 | 4.4% LTR (GPG) | Students, professionals, BoG growth leader |
| Thessaloniki suburbs | €400,000 | 4.4% city figure (GPG) | GV value arbitrage vs city |
| Crete (Chania / Apokoronas) | €400,000 | higher gross revenue STR (licensed) | Tourism, lifestyle, GV redirected demand |
...
## Greece property market forecasts
...
## Risks and red flags in the forecast


Four assumptions carry this forecast, and each of them is a policy decision rather than a market fact: that the capital gains suspension is extended again, that the new-build VAT suspension is renewed for 2027, that the Athens short-term rental moratorium expires on schedule at the end of 2026, and that Golden Visa thresholds are not raised a second time. Model your exit with each of them reversed.
A forecast is a set of assumptions, and four of the ones underpinning the Greek market are worth naming rather than inheriting.

- **Capital gains tax is suspended, not abolished.** The suspension has been rolled forward repeatedly, but it is a policy choice that a future budget can reverse. Model your exit under both the current suspension and a reinstated 15% rate; if the investment only works under the former, it is thinner than it looks.
- **The VAT suspension on new build is on the same footing.** It has renewed without a break since 2010, and a lapse would add 24% to new-build first sales from 2027.
- **Yield compression as prices rise.** Greek rents have not tracked price growth of nearly 10% over two years. A rising market lowers yield unless rents follow, and rents are constrained by local wages rather than by foreign buying power.
- **Golden Visa demand is policy-driven.** A large share of foreign transaction volume responds to residency rules rather than to fundamentals. Threshold changes move that demand quickly, as the 2024 reform demonstrated.

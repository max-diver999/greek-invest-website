...
Patra, Greece's third-largest city and the Peloponnese's largest urban rental market, offers the region's lowest per-square-metre entry on typical resale apartments, often €1,200 to 1,800. Global Property Guide data points to approximately **4.81% gross long-term rental yield**, the clearest yield anchor in the peninsula.
...
Net yields after ENFIA, management (8 to 12% LTR), maintenance, vacancy, and Greek rental income tax (15% on first €12,000) typically land **1 to 1.5 percentage points below gross**. Model conservatively.

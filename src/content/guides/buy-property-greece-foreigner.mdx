...
description: "Buy property in Greece as a foreigner: EU and non-EU rules, AFM, 3.09% transfer tax, 7–10% total costs. Step-by-step 2026 guide."
pubDate: 2026-06-17
...
<TldrBlock text="Foreigners — EU and non-EU alike — can buy property in Greece with few barriers. You need a Greek AFM tax number, a Greek bank account, a mandatory notary, and a lawyer for title checks. Total costs run 7–10% on top of the purchase price (transfer tax alone is 3.09%). Non-EU buyers face extra steps in border zones and must wait for government approval before completing. Budget 2–4 months for a standard transaction; 6–8 months if a restricted zone is involved." />
...
<FaqBlock items={[
  ...
  },
  {
    ...
    answer: "Total transaction costs for a resale purchase typically range from 7% to 10% of the purchase price. The main components are: transfer tax (3.09%), notary fees (1%–1.5%), lawyer fees (1%–2%), land registry / cadastre registration (0.475%), and real estate agent commission (2%–4% if applicable). Budget at least 8% for a typical resale transaction to be safe."
  },
  {

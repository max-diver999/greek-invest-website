...
The tier follows the cadastral parcel, not the postcode or the marketing description, and getting it wrong costs €400,000. The €800,000 band covers the whole Attica regional unit, the whole Thessaloniki regional unit, Mykonos, Santorini and every island with a permanent population above 3,100, which catches Paros and Tinos and spares Antiparos. Two specific traps recur. A property advertised as Glyfada can sit in a neighbouring municipality, and a scheme forty-five minutes from Thessaloniki airport may be in Halkidiki at €400,000 or in the Thessaloniki regional unit at €800,000 depending on a boundary no agent's brochure draws. Confirm the regional unit and the municipality from the cadastral extract before the reservation, because after the deposit the arithmetic is fixed.
...
This is the most expensive mistake on the list because it is usually discovered after completion, when the money has moved and the property cannot be unwound. The rule counts only main habitable usable area, κύρια χρήση, as recorded on the building permit and the Electronic Building Identity. A property marketed at 164 square metres can certify at 112 once 22 square metres of balconies, 12 of parking and 18 of auxiliary basement are excluded, and 112 fails outright: there is no rounding, no discretion and no appeal on area. The remedies afterwards are limited to legally merging an adjacent unit into a single horizontal property, which requires a willing neighbour and a notarial act, or selling and starting again with the acquisition costs of 7% to 10% written off.
...
You have 60 days from cadastral registration to file, and the clock starts when the transfer is entered in the land registry, not when you sign at the notary. In busy offices that registration can lag the signing by weeks, which is exactly why buyers who count from the notary date arrive at the Ministry late.
...
The developer's lawyer, the agent's lawyer and the notary all have a role in the transaction, and none of them is representing you. An independent Greek-qualified lawyer is the only party whose job is to find the encumbrance, the unpaid ENFIA, the unpermitted extension or the area shortfall before your money moves — which is precisely why the discount for using theirs is offered.

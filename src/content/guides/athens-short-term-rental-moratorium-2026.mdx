...
Athens STR moratorium zones include Kolonaki, Exarchia, Monastiraki, Koukaki, and parts of Plaka within the core municipality where STR registration exceeded the 40 percent density trigger, while suburbs such as Glyfada, Kifisia, Marousi, and Piraeus remain on standard AΜΕΑ licensing rules through end-2026. MORE Group maps overlap between these zones and the €800,000 Golden Visa Attica tier before buyers commit deposits.
...
Athens STR operators with grandfathered AΜΕΑ licences must keep fire safety and energy certificates current, declare all rental income through AADE, and display registration numbers on every platform listing to avoid penalties that reached €20,000 per unit under 2024 enforcement circulars. MORE Group pauses any GV qualifying asset STR activity immediately because Law 5100/2024 overrides local licence status.

...
Run at net rather than gross, the two converge far more than the headline yields suggest. Kolonaki's prestige pricing compresses its percentage return, while modern Riviera stock with parking and good energy performance commands rents that hold up against its higher entry price, landing near 2.66% net. The real divergence is not in the annual figure but in the exit: the Riviera sells to an international pool, the centre largely to a Greek one.

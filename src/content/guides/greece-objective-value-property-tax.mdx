...
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/w_1200,q_85,f_webp/more-group/greece/curated/sailing-yachts-near-the-caves-at-kleftiko-on-mil-48e917b0"
readingTime: 10
relatedSlugs:
...
Transfer tax is charged at 3.09% on the higher of your agreed price and the property's objective value, which means agreeing a lower price does not lower the tax once the objective value exceeds it. On a property agreed at €380,000 with an objective value of €420,000, the tax is €12,978 rather than €11,742, and the €1,236 difference arrives after the price is fixed.
...
Objective value (αντικειμενική αξία) is the figure the Greek state assigns a property using zone rates, floor, age, frontage and surface area, and FMA transfer tax at 3.09% is charged on whichever is higher, the objective value or the agreed price. On a property agreed at €380,000 with an objective value of €420,000, the tax is €12,978 rather than €11,742. The 2022 and 2024 revisions raised zone rates across most of Attica and the popular islands, which narrowed the historic gap between objective and market values and in some transitional districts inverted it. Two practical consequences follow for a buyer. Agreeing a price below objective value does not reduce the tax bill and creates an under-declaration exposure instead. And a Golden Visa purchase modelled at exactly €400,000 plus 7% can breach its budget without the price moving at all, so the objective-value calculation belongs in writing before the preliminary agreement rather than at the notary.
...
ENFIA is calculated on objective value rather than market price, which is why the annual bill on a €400,000 property is rarely what a foreign owner expects. The principal tax runs €2.00 to €16.20 per square metre depending on zone rate, floor, age, frontage and surface area, and a wealth supplement of 0.55% to 1.15% applies once total objective value across a portfolio passes roughly €500,000. On a mid-range Athens apartment the annual bill is typically €500 to €2,000; on a coastal property in a high zone rate it can reach €800 to €2,000 on its own. The link to objective value cuts both ways: the 2022 and 2024 revisions that raised zone rates increased ENFIA at the same time as they increased the transfer tax base, so a district that repriced upward became more expensive both to buy into and to hold.
...
Four things should stop a deposit: an objective value nobody has produced in writing, a listing area that has not been reconciled with the engineer's certificate, a seller who cannot show ENFIA clearance, and any unpermitted work that has not been regularised. All four are answerable in days and all four cost months once the money has moved.
...
## Objective Value vs Market Value on a Riviera Apartment

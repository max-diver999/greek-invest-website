...
|---|---|---|---|
| Long-term residential | GV investors, centre buyers, yield focus | 5.43% city-wide; 6–7.5% Kipseli | Legal everywhere |
...
| Mid-term furnished (1–11 months) | Corporate lets, digital nomads | Between LTR and STR | Grey zone; requires legal drafting |
...
9. Model total acquisition cost at 7–10% above the purchase price: 3.09% transfer tax, notary, lawyer, cadastre registration, and agent commission where applicable.
...
| Kipseli LTR yields 6–7.5% in yield-positive stock | GV qualifying asset cannot be used for Airbnb |
| Metro, schools, international buyer pool | Title and building-compliance risk on older resale stock |
| Apartment prices +6.1% with room below pre-crisis peaks | Net yields 1–1.5 points below gross after tax and costs |

...
The general due diligence guide covers title search going back at least 20 years, cadastre registration status, encumbrances including mortgages and seizures, ENFIA tax arrears, building permit compliance, and border zone clearance for non-EU buyers. These six tracks apply to every Greek property purchase regardless of purpose.
...
## Section 1: Title Deed and Cadastre: The 20-Year Chain
...
## Section 2: Urban Planning and Building Permit Compliance

Urban planning compliance verifies that the current physical state of the property matches every applicable building permit. In Greece this check is more complex than in most EU countries because a regularisation framework exists for unauthorised construction, meaning some illegal works can be legalised on payment of a penalty rather than requiring demolition.

For Golden Visa buyers the permit check matters beyond the general conveyancing requirement because the engineer who issues the area certificate for GV purposes also documents permit status. A property with unresolved illegal construction cannot receive a clean engineer certificate, which means it cannot proceed to a Golden Visa application even if the title is otherwise clean.
...
## Section 3: Golden Visa Eligibility Checks
...
## Section 4: ENFIA Arrears, Communal Charges, and Engineer Certificate
...
## Section 5: Border Zone Clearance

Greece designates certain areas near national borders, including specific Aegean islands and some mainland frontier regions, as restricted zones where non-EU and non-EEA nationals require advance Ministry of National Defence approval before completing a property purchase.
...
## Section 6: Developer and Off-Plan Properties
...
## Section 7: Bank Transfer Traceability Under Circular 1/2026
...
## Section 8: Pre-Deposit and Pre-Deed Gates

The checklist items in the previous sections fall into two mandatory sequential gates. Nothing from the second gate substitutes for the first; both must clear in order.
...
Use this decision framework: if any Golden Visa-specific row fails at pre-deposit, do not pay the 10% deposit even when general title checks look clean. The Ministry rejects applications on usable-area and single-deed defects that standard resale DD sometimes misses.

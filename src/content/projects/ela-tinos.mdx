...
## What Is Ela Tinos, and Who Is Solena?
...
## Tinos on the Cyclades Tier Map: How Strong Is Demand Here?
...
## Does Ela Tinos Clear the €800K Threshold and the STR Ban?
...
Tinos has a permanent population above the 3,100 line that Law 5100/2024 draws, so it sits in the €800,000 tier rather than the €400,000 one, which surprises buyers who reasonably assume a quieter Cycladic island prices like Antiparos. On top of that, Ela Tinos is a hotel-residence of twenty-nine suites, and a hybrid format creates two separate problems for a Golden Visa file: a suite is frequently below the 120 m² certified main usable area minimum, and a hotel operating pool is short-term accommodation, which the permit prohibits on the qualifying asset regardless of how the arrangement is contracted. A buyer wanting residency through this scheme needs a single deed at €800,000 or more, an engineer's certificate at 120 m² or above, and a written confirmation that the unit sits outside any rental pool. All-in budget on such a deed is roughly €856,000 to €880,000.

## What hotel-residence hybrid risks apply?


Three features of a hotel-residence structure can each disqualify a Golden Visa application on their own. The unit may be classified as tourist accommodation rather than residential on the deed. It may sit on a shared title with the wider development rather than on its own. And any mandatory rental-pool or management agreement is, in substance, short-term letting on the qualifying asset, which Law 5100/2024 prohibits. Ask for the deed and the management contract before the reservation.
...
Ela Tinos is the only completed property in this set, which removes construction risk entirely and replaces it with a different problem. It is a hotel-residence hybrid, and that structure sits awkwardly against Golden Visa rules: the qualifying asset must be residential, on a single deed, and cannot be operated as short-term tourist accommodation for the life of the permit. Verify the deed classification before treating this as a residency route.
**Pros**
...
The central tension at Ela Tinos is that its two strongest features work against a Golden Visa file. A twenty-nine-suite hotel residence delivers professional management and a serviced product, but a rental pool is short-term accommodation, which the permit prohibits on the qualifying asset for the whole five-year term, and suite formats frequently measure below the 120 m² of certified main usable area the rule requires. Tinos also sits in the €800,000 tier rather than the €400,000 one, because its permanent population is above the 3,100 threshold in Law 5100/2024, so the qualifying budget is roughly €856,000 to €880,000 all in. As a lifestyle purchase with managed letting on a non-qualifying basis the proposition is coherent; as a residency vehicle it requires a deed and a written exclusion from the pool.

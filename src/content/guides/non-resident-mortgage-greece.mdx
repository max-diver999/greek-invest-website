...
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/greece/heroes/non-resident-mortgage-greece-a8013265.webp"
heroAlt: "Poros town rooftops above the harbour"
faq:
...
The financing question in Greece starts from an unusual baseline: most foreign purchases are simply not financed. RE/MAX Greece data for 2025 shows 78% of foreign buyers choosing resale over new build and 48% transacting in the €100,000 to €200,000 band, price points where a mortgage adds more delay than leverage. Resale deals close in four to eight weeks in cash; a Greek mortgage approval for a non-resident routinely takes three months, and sellers price that difference in.
...
Legally yes, practically it depends almost entirely on your fiscal connection to Greece rather than on your income. A non-resident with no Greek tax presence is unlikely to be approved by a mainstream Greek bank whatever their earnings. An EU national who has transferred tax domicile to Greece, spending more than 183 days a year there, is assessed much like a domestic borrower. Non-EU applicants sit at the hardest end, with pink-slip fund documentation and visa-status conditions layered on top.
In practice:
...
## Do EU and Non-EU Buyers Get the Same Access to Credit?
The gap is wide enough to change the buying strategy. An EU national with Greek fiscal residency is the most viable borrower and is treated close to a domestic applicant. A non-EU national who is not resident is rarely approved by Greek commercial banks at all, and should plan on a cash purchase. Between those poles, an EU non-resident may borrow with documented foreign income, and a non-EU holder of a stable long-term permit is judged case by case.
...
Greek banks cannot see your foreign credit history, so the documentation burden replaces the credit score. Expect to supply an AFM, two to three years of tax returns or audited accounts from your country of residence with official translation and apostille, a formal credit report from your home bureau, a valuation by a bank-approved surveyor, and for non-EU buyers a pink slip evidencing that the funds were legally imported. The loan is calibrated on the lower of purchase price or assessed value.
...
A Greek systemic bank underwriting a non-resident applies conservative and fairly uniform criteria: a deposit of at least 40%, so €160,000 on a €400,000 property, three years of certified tax returns from the applicant's home tax authority, six months of pay slips and bank statements evidencing salary, an independent valuation by the bank's own engineer, and a title check by the bank's lawyer that is separate from and does not replace your own. Debt service is typically capped around 30% to 40% of documented net income. Costs on approval include mortgage registration at 1.2% of the loan, roughly €2,880 on a €240,000 advance, a valuation fee of €300 to €500, and compulsory life and property cover adding about €600 a year. From application to funds released takes around twelve weeks.

## How Much Will a Greek Bank Lend a Non-Resident?
...
## What Are the Alternatives to a Greek Mortgage?
Because Greek lending to non-residents is narrow, most foreign buyers finance the purchase somewhere other than Greece. The four routes that actually get used are equity release against a property in your home country, a developer instalment plan on new build with 20% to 30% down and the balance at completion, portfolio-backed lending from an international private bank, and outright cash. The last accounts for the large majority of foreign purchases and is the only one that never delays a deed.
...
This is the point where financing and residency collide, and it is not negotiable. All three Golden Visa tiers require the investment funds to be transferred from abroad and evidenced through the banking system. A Greek mortgage fails that test by definition, because the borrowed capital was never imported. Applicants who use local debt to reach €400,000 or €800,000 find the file rejected on the source-of-funds requirement rather than on the property.
...
## How Do You Move Your Funds Into Greece?
...
## Why Instruct a Lawyer Before Approaching a Bank?
...
## What Terms Do Greek Systemic Banks Offer Non-Residents?
Where it does happen, the terms are conservative. On a €400,000 property the systemic banks, Eurobank, Alpha Bank, Piraeus Bank and National Bank of Greece, typically required a 40% deposit of €160,000 and took around twelve weeks from application to release of funds. Budget mortgage registration at 1.2% of the loan and mandatory life and property cover adding roughly €600 a year to holding costs, on top of the standard acquisition stack.
...
Here is the profile and the cost breakdown on a representative file:

| Line | Amount |
| --- | --- |
| Property value | €400,000 |
| Required down payment (40%) | €160,000 |
| Loan advanced (60% LTV) | €240,000 |
| Mortgage registration fee (1.2% of the loan) | €2,880 |
| Bank valuation and legal review | €600 to €1,000 |
| Mandatory life and property cover | approx. €600 a year |
| Standard acquisition stack on top (transfer tax, notary, lawyer, registry) | 7% to 10% of price |
| Time from application to funds released | about 12 weeks |

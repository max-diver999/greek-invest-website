...
The exclusions matter more than the premium, and two of them recur. Earthquake cover is frequently excluded from the cheapest policies in a country sitting on an active seismic zone, and flood cover is often excluded or heavily limited on ground-floor and basement units in coastal locations. Insist on a written coverage summary table rather than a headline premium, and read the exclusions before comparing prices.
...
Cover requirements differ sharply by how the property is held and used. A mortgaged purchase requires buildings cover with a loss-payee clause, and adding earthquake and contents typically brings the annual premium to €700 to €1,200. A long-let Golden Visa asset needs landlord liability. A property left empty for months needs to be checked for an unoccupancy clause, which many policies apply after 30 to 60 consecutive days and which quietly voids cover.

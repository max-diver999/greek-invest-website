...
tags:
  ...
  - "cyclades vs crete"
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/greece/heroes/cyclades-property-investment-guide-0205badc.webp"
heroAlt: "Aerial view of a Cycladic island town on a narrow headland"
relatedSlugs:
...
| Typical LTR gross yield (premium islands) | 2.5 to 4.5% | Athens 5.43%; Chania Prefecture ~4.0% |
...
Short-term rental licensing on Mykonos is among the most regulated in Greece. ΑΜΑ registration, tax compliance, and municipal caps apply to non-Golden Visa properties. The qualifying Golden Visa asset, however, cannot participate in STR under any circumstances. See the [Golden Visa short-term rental ban](/guides/greece-golden-visa-no-short-term-rental/) guide for the full distinction.
...
Three separate regimes get conflated here and the cost of confusing them is high. A Golden Visa qualifying asset can never be let short-term, at any location, for the life of the permit, and long lets in the Cyclades run roughly 2.5% to 4.5% gross. A non-qualifying property with a registry licence can reach 6% to 10% seasonally. And personal use is unrestricted on either. The 6% to 10% figures quoted in island marketing belong to the second category only.
...
For Cyclades Golden Visa investors, model long-term let income as the base case, typically 2.5 to 4.5% gross on premium islands after matching realistic rents to purchase price. Net yields after Greek rental income tax (15% on first €12,000), ENFIA, management, maintenance, and void periods fall 40 to 55% below gross headlines, consistent with national patterns described in the [highest rental yield areas in Greece](/guides/greece-rental-yield-guide/) guide.

### 2. Non-GV Cyclades property: STR possible with licensing

A separate property not used for the Golden Visa application may hold an ΑΜΑ short-term rental licence subject to national and municipal rules. On Mykonos and Santorini, licensing is competitive and compliance-heavy. Seasonal gross yields on licensed STR assets can earn materially more in peak months, but the operating window is roughly May to October, OTA commissions run 15 to 20%, professional management is near-mandatory, and net full-year yields often land in the 4 to 6% range.
...
The [highest rental yield areas in Greece](/guides/greece-rental-yield-guide/) data shows Athens at 5.43% city-wide and Crete's implied 4.0% in Chania Prefecture, with licensed Crete STR higher seasonally. Cyclades premium islands trade at lower percentage yields because:
...
| Licensed STR (non-GV) | higher seasonal gross revenue | higher seasonal gross revenue | Prohibited on GV asset |
...
The Cyclades are a second-home market first and an investment market second, and that ordering governs the exit. Transactions cluster in spring and autumn when ferries run reliably and buyers can actually inspect, so a sale initiated in November effectively waits for March. Resale on the smaller islands routinely takes six to twelve months longer than on Crete or the mainland, which is a holding-cost question as much as a pricing one.
...
| Complex compliance | ΑΜΑ licensing, tax registration, engineer's certs, caldera building rules |
...
The real comparison is not Mykonos against Santorini, it is the Cyclades against Crete, and the tier map settles most of it. Crete is uniformly €400,000; the Cyclades split, with Mykonos and Santorini at €800,000 and islands under 3,100 residents at €400,000. Crete then adds a 26-week season, year-round flights, two cities with real tenant depth, and a resale market with local as well as foreign demand.
...
| STR on GV asset | Prohibited | Prohibited |
| STR on separate non-GV asset | Seasonal; licensed; complex | Seasonal; licensed; higher gross revenue peak |
...
Recommendation: Crete at €400,000 delivers better LTR economics and Golden Visa efficiency. If Cyclades appeal is non-negotiable, structure two assets: €800,000 Cyclades GV property on LTR plus separate non-qualifying STR unit, only if total capital supports both legs. Read the [highest rental yield areas in Greece](/guides/greece-rental-yield-guide/) comparison before committing.
...
Recommendation: Paros or Naxos offer more square metres and island character than Mykonos at lower €/m². STR licensing may be available since no GV restriction applies, but confirm ΑΜΑ eligibility before purchase. Seasonal rental can offset holding costs; engineer's due diligence on resale stock remains critical given 78% resale share.

---
title: "Greece Golden Visa Circular 1/2026 Explained for Buyers"
...
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/w_1200,q_85,f_webp/more-group/greece/curated/by-night-129f9d37"
featured: false
relatedSlugs:
  - "news"
...
Circular 1/2026 replaced an open-ended queue with two phases on a stated clock: a 15-calendar-day completeness check, then substantive review. The practical significance is not speed but the reset — an incomplete file does not wait in line while you fix it, it restarts the 15-day clock from the day the missing document arrives.
...
## The 120 Square Metre Residential-Use Rule
...
Nothing about your rights as a permit holder changed. The five-year permit, the unlimited renewals, the zero minimum stay and the family reunification rules all survive Circular 1/2026 untouched. What changed is the evidence required to obtain and renew, and the order in which the Ministry looks at it.
...
**Insider tip:** Lodge your engineer property classification certificate within 30 days of application submission. A single missing apostille on a criminal record restarts the full 15-day Phase 1 clock, and the total processing time moves by six to eight weeks rather than by the fifteen days you lost.
...
Circular 1/2026 documentation checklist for property-route Golden Visa investors requires six transaction documents and four identity documents before Phase 1 starts: notarised deed or full off-plan payment proof, cadastre extract under 30 days old, engineer tier certificate, Greek bank SWIFT trail, insurance at ENFIA base value, valid passport with 18 months remaining, apostilled criminal records, health cover, and the 2026 application form version only. A recurring red flag is two co-buyers splitting an €800,000 Attica apartment at €400,000 each. That fails the tier, because each investor has to meet the zone minimum independently on a qualifying investment of their own. Conversion-route buyers at €250,000 need completion inspection signed before filing, with at least 40 percent of restoration cost disbursed on listed buildings. Payment proof that bypasses the buyer-named Greek account is returned in Phase 1 under Circular 1/2026 unified banking rules, resetting the 15-day completeness clock from day one.

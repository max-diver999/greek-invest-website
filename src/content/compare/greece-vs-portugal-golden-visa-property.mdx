...
faq:
  ...
  - question: "Which program has a bigger application backlog?"
    answer: "Both programs have faced backlogs. Portugal's SEF-to-AIMA transition created multi-year delays in 2022–2024, though processing has improved under the new immigration authority. Greece had approximately 11,553 applications pending at the end of 2025 while simultaneously approving a record 8,879 permits. Both authorities now publish processing-time guidance, and applicants should verify current wait times before choosing primarily on speed grounds."

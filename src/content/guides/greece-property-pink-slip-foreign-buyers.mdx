...
The Pink Slip is the certificate a Greek tax office (DOY) issues when someone with no Greek residential address registers for an AFM tax number — formally the registration certificate for non-residents, known as the pink slip after the colour of the paper it was historically printed on. It exists because Greek tax administration is built around a registered Greek address: AADE needs somewhere to send an ENFIA assessment or an E9 query, and a foreign address does not satisfy that requirement. The Pink Slip closes the gap by recording a Greece-based fiscal representative in place of a Greek address.
...
A Greek bank cannot onboard a non-resident customer without a Greek tax identity, and the Pink Slip is what supplies it: the certificate confirms non-resident status and names the Greek fiscal representative to whom AADE will send correspondence. Without it the AFM exists but cannot be used to open an account, and without an account the purchase price cannot move through a Greek credit institution as Circular 1/2026 requires for a Golden Visa file. That sequencing is why the Pink Slip sits on the critical path rather than in the paperwork pile. Allow 1 to 3 business days at the DOY for the AFM and Pink Slip together when attending in person, 5 to 14 business days plus courier transit when working through an apostilled power of attorney, and a further 5 to 10 business days for the bank account itself.

## What Does Circular 1/2026 Require of Your Bank Trail?
...
## What Documents Do You Need for the Pink Slip?
...
## Wire transfer sequence: step by step


The purchase price has to arrive from abroad and be paid through a Greek credit institution, which means the money moves in a documented chain rather than in one transfer to the seller: AFM and Pink Slip, then a Greek bank account, then the inbound wire, then the bank certificate that evidences it, then the notary. Budget six to eight weeks end to end. The DOY appointment and the bank's KYC review, not the wire itself, are what set the pace.
...
## Why Do Greek Banks Delay Non-Resident Accounts?
...
## Can You Get the AFM and Pink Slip Without Flying to Greece?
...
## Where Does the Pink Slip Sit in the Purchase?
...
## Risks and red flags around the Pink Slip


None of the Pink Slip risks are legal risks: the certificate is issued as of right to any non-resident who applies with the correct paperwork. The risk is timing and consistency. It sits on the critical path of the purchase, it cannot be back-dated, and every document downstream of it copies the name and address exactly as they appear on it.
The Pink Slip is administrative rather than difficult, but four things reliably delay it.

- **Leaving it until the notary asks.** Notaries will not execute a deed for a non-resident buyer without it. Requesting it in the same week as the signing date is the most common cause of a missed slot.
- **Fiscal representative confusion.** The representative is a Greek tax resident who accepts correspondence on your behalf. Appointing your lawyer is normal; assuming the notary will act is not.
- **Mismatched documentation.** The name and address on the Pink Slip application must match the AFM registration and the deed exactly. Transliteration differences between a passport and an earlier Greek document are enough to send the file back.
- **Assuming it substitutes for tax residence.** The Pink Slip confirms you are taxed elsewhere. It does not exempt you from Greek ENFIA, E9 filing, or tax on Greek-source rental income.

...
Use this table as a starting point. The figures are indicative gross yields compiled from transaction and rental market data. Net yields after tax, management and vacancy are typically 40 to 55% lower.

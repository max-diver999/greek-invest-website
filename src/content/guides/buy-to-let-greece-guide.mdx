...
- **Progressive rental tax from the first euro.** There is no tax-free allowance for non-residents. Rent is taxed at 15% to €12,000, 35% to €35,000 and 45% above. A second property pushes you up the bands, so portfolio yield falls as the portfolio grows.

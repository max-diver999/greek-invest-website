...
**The yield-focused buyer at €800,000.** Thessaloniki's 5.0% to 6.5% gross band is genuinely above Attica, but reaching the threshold means buying more floor area than the local rental market pays proportionally for. Underwrite the larger unit at the bottom of the band, let to a family or academic household on a twelve-month lease.
...
- **Yield-to-threshold mismatch.** Gross yields of 5.0% to 6.5% are attractive, but €800,000 of qualifying capital in Thessaloniki buys far more square metres than the local rental market can absorb at proportionate rent. Expect the yield to fall as the unit size rises.

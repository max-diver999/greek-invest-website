...
<FaqBlock items={[
  ...
  {
    question: "What are the total costs of investing in Greek property?",
    answer: "Total acquisition costs for a resale investment typically run 7% to 10% of the purchase price: 3.09% transfer tax, notary fees of 1%–1.5%, lawyer fees of 1%–2%, cadastre registration of 0.475%, and agent commission of 2%–4% where applicable. Ongoing costs include annual ENFIA property tax and progressive income tax on rents. A detailed cost model by budget tier is available in the cost of buying guide."
  },
  {
    question: "Which Greek cities offer the best investment returns?",

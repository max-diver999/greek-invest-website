...
description: "A to Z glossary for buying property in Greece: AFM, ENFIA, FMA, objective value, symvolaio, cadastre, AMA/STR, Golden Visa tiers, and the 120 m² rule."
pubDate: 2026-06-17
...
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/greece/heroes/greek-property-glossary-foreign-buyers-2d3eb6f5.webp"
heroAlt: "Narrow whitewashed alley in the old town of Athens"
relatedSlugs:
...
The entries are alphabetical for lookup, but a purchase is not. If you are reading this before your first offer, the terms that matter now are AFM, the Pink Slip, border zone status under Act 171, the cadastre and the KAEK; everything about deeds, objective value and ENFIA clearance becomes relevant later. The table below maps the terms to the stage at which you will meet them.
...
## A to Z Terms for Foreign Property Buyers in Greece
...
Three numbers do most of the work in Greek property vocabulary and they are worth fixing before the rest of the glossary. €800,000 is the Golden Visa threshold in Attica, the Thessaloniki regional unit, Mykonos, Santorini and islands with more than 3,100 permanent residents. €400,000 is the threshold everywhere else, which includes Crete, the Peloponnese, Halkidiki, the Ionian islands and the smaller Cyclades. €250,000 is the conversion tier, available anywhere for a listed or commercial building turned into residential use with the works completed before the application. The first two require at least 120 square metres of certified main usable area on a single title deed. On top of any of them, add 7% to 10% for the acquisition stack: 3.09% FMA transfer tax, notary at 0.8% to 1.2%, lawyer at 1% to 1.5%, land registry at 0.475% to 0.65%, agent at 2% to 2.5%, and 24% VAT on every professional fee.
...
Six terms account for almost all of the money a foreign buyer spends beyond the price. FMA (Φόρος Μεταβίβασης Ακινήτων) is the 3.09% transfer tax, charged on the higher of the agreed price and the objective value. Αντικειμενική αξία is that objective value, the state's own assessment. Συμβολαιογραφικά are notary fees at 0.8% to 1.2% plus 24% VAT. Δικηγορικά are lawyer fees at 1% to 1.5% plus VAT. Κτηματολόγιο registration costs 0.475% to 0.65% plus VAT. And ENFIA is the annual holding tax at €2.00 to €16.20 per square metre. Together the first five total 7% to 10% of the purchase price, which on a €400,000 deed is €28,000 to €40,000 and on €800,000 is €56,000 to €80,000.

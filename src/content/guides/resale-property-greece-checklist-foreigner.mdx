...
description: "Resale property Greece checklist: title search, ENFIA clearance, engineer survey, notary prep, 3.09% transfer tax. Step-by-step for foreign buyers."
pubDate: 2026-06-17
...
## How Does Resale Diligence Differ From New-Build?
...
Resale is what most foreign buyers in Greece actually purchase, and 78% choose it over new build, historically because VAT at 24% made new construction roughly a fifth more expensive to acquire until the suspension removed the gap. The diligence differs in direction rather than in depth. A resale file looks backwards: a title search through the ownership chain, ENFIA clearance for the last five years, cadastre status including any unknown-owner or forest-registry overlap, and an engineer survey for unpermitted works that transfer with the property along with any outstanding regularisation fines. An off-plan file looks forwards: the building permit, the developer's corporate solvency, a bank guarantee over stage payments, and a contractual delivery date. Both carry the same 7% to 10% acquisition stack and the same 3.09% transfer tax while the VAT suspension holds.

## Step 1: Get Your Greek Tax Number (AFM)


The AFM is free, takes one to five working days, and blocks everything until it exists: no Greek bank account, no transfer tax payment, and no appearance in a notarial deed without one. Your lawyer applies to the local AADE office with a passport copy and proof of foreign address. Start it the week you begin viewing rather than the week you make an offer, because it costs nothing to hold and everything to lack.
...
Non-EU buyers should run this check before spending anything else on due diligence, because a negative answer ends the purchase rather than complicating it. Designated border zones cover several of the most-requested locations in Greece, including eastern Aegean islands and frontier-adjacent mainland regions. Where clearance is required it comes from the Ministry of National Defence and typically adds three to six months, so it has to be a condition in the preliminary agreement rather than a hope.
...
This is the step that most often kills a resale purchase, and it takes days rather than weeks. Your lawyer traces ownership back a minimum of twenty years, confirming each transfer is valid and that no break exists in the chain. Greek succession law is what usually complicates it: a single property can carry multiple heirs with unequal shares, some abroad and some untraceable, and every one of them must consent to the sale.
...
The title search is the step that most often ends a transaction, and it is cheap relative to what it prevents: €200 to €500 in lawyer time for twenty years of ownership history, plus €50 to €150 for the cadastral extract. What it looks for is specific. An unbroken chain of ownership with every heir having signed. Mortgages, pre-notations and seizures on the encumbrance record. The ΚΑΕΚ parcel identifier matching the property you viewed. Registration status showing full rather than provisional registration, because a property recorded with the State as unknown owner cannot be sold until a court corrects it, a process running 12 to 24 months. And any forest registry overlap, which on a rural or semi-rural plot can render part of the land unbuildable regardless of what the seller believes.
...
For resale stock built before 2000 this is the highest-value few hundred euros in the transaction. The Greek engineer survey is a planning-compliance check rather than a condition report: it compares the physical building against every permit on record, certifies main usable area for the 120 m² Golden Visa test, identifies unauthorised construction and its regularisation status, and prepares or updates the Electronic Building Identity without which the property cannot legally transfer.
...
The Greek preliminary agreement is legally binding in a way an English exchange of contracts is not preceded by, which cuts both ways. The standard deposit is 10%. If the buyer withdraws without cause the deposit is forfeited; if the seller withdraws, the customary remedy is return of double the deposit. That symmetry is why gazumping is rare in Greece, and why nothing should be signed before the title search and engineer certificate are back.
...
## What Does a Greek Resale Purchase Cost in Total?

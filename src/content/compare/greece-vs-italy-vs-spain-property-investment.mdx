---
title: "Greece vs Italy vs Spain: Property Investment in 2026"
...
Spain formally ended its property Golden Visa on 3 April 2025. The route had operated since 2013 with a €500,000 minimum investment in Spanish real estate. Existing permit holders whose applications were approved before the cut-off may renew under original terms. No new property-route applications are accepted.
...
Greece is the cheapest of the three to buy into, and the gap is wide enough to change a break-even calculation. Greek transfer tax is a flat 3.09%, taking the total acquisition stack to 7% to 10%. Italy and Spain both run 9% to 13% on a second home depending on region and buyer status, with Spanish regional transfer tax alone commonly at 6% to 10%. On a €500,000 purchase that difference is €15,000 to €25,000 before anything else is compared.
...
The three markets answer three different questions. Greece is the only one of the three that still converts a property purchase into EU residency, at 4.4% to 5.4% gross nationally. Italy is a lifestyle market where prestige-zone yields are thin and the cost stack is the highest of the three. Spain offers competitive yields and no residency route at all since April 2025, so a Spanish purchase in 2026 is a property decision only.
...
The right market depends almost entirely on whether you need a residence permit. A non-EU buyer who does should be looking at Greece, because it is the only one of the three offering the route. An EU citizen buying a second home should ignore residency entirely and choose on price, season and personal use. A yield-focused buyer should compare net rather than gross, since Greek rental tax starts at 15% from the first euro with no allowance.
...
## Where Each Market Sits in This Research
...
## Risks and red flags in this comparison


Of these three countries, only Greece still offers residency for buying property. Spain closed its route in April 2025 and Italy never had one, which means two-thirds of this comparison is about lifestyle and yield while one-third is about a permit — and most of the comparison content still online has not caught up.
Each market carries a different structural risk, and the residency picture is the sharpest divider.

- **Spain has no property Golden Visa.** The route closed in April 2025. A Spanish purchase today is a property decision only, and any comparison that still prices in residency is out of date.
- **Italy's flat-tax regime is not a residence permit.** The €200,000 forfait attracts tax residents; it does not substitute for the elective residence visa, which requires proven passive income rather than a property purchase.
- **Greece's constraints are physical.** One property, one deed, 120 m² of certified usable area, and no short-term letting on the qualifying asset. These remove a large share of otherwise attractive stock.
- **Transaction cost spread.** Italy's cost stack on a second home runs materially higher than Greece's 7% to 10%, which changes the break-even holding period more than the yield difference does.

...
On percentage return the centre wins clearly, and it is not close. Transitional central districts such as Kipseli produce 6.0% to 7.5% gross on long lets against 4.5% to 5.5% for Riviera stock, because Riviera prices carry a coastal and Ellinikon premium that rents do not match. Since the Golden Visa asset must be let long-term, that gross gap is the honest comparison; short-term rental figures quoted for Riviera property are not available on a qualifying property.

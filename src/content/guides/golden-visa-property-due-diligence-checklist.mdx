...
For the full six-track foundation, read [Due Diligence Greece Property: The Complete 2026 Checklist](/guides/due-diligence-greece-property/) first. This guide assumes that foundation and builds the Golden Visa-specific layer on top. The two documents are used together, not as alternatives. [British buyers](/guides/brexit-uk-buyers-greece-property/) should read the post-Brexit Schengen and residency rules alongside this checklist.
...
<InlineCta
  text="Want three Golden Visa properties screened against this checklist? Tell us your tier and region and we return file-ready options."
  buttonText="Get Golden Visa shortlist"
  buttonHref="/get-shortlist/"
  ctaId="dd_mid_shortlist"
/>
...
| --- | --- | --- |
| Resale Golden Visa (Crete €400K) | Title chain, ENFIA, engineer 120m² usable area | Communal charges zero; STR prohibition declaration signed. See [Crete €400K guide](/guides/crete-golden-visa-400000-property/) for market context. |

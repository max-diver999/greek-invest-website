---
title: "ENFIA Greece 2026: Rates per m² and €450K Athens Example"
description: "2026 ENFIA bands from €2 to €16.20/m², wealth surcharge above ~€500K, E9 due 31 May, and how non-residents pay through Taxisnet with a Greek AFM."
pubDate: 2026-06-17
...
**Quick answer:** ENFIA is Greece's annual property tax, €2 to 16.20 per m² on the main component, plus a 0.55 to 1.15% wealth supplement on portfolios above roughly €500,000 objective value. Bills arrive each August via Taxisnet; foreign owners need a Greek AFM first. File or update E9 by 31 May every year or your assessment drifts wrong. Golden Visa buyers stress-testing hold costs should read [Crete €400K property options](/guides/crete-property-investment-guide/) and the [Golden Visa due diligence checklist](/guides/golden-visa-property-due-diligence-checklist/) before locking a reservation.
...
<InlineCta
  ...
  buttonText="Get a holding-cost estimate"
  buttonHref="#lead-form"
  ctaId="enfia_top_form"
  whatsapp={true}
  whatsappMessage="Hi, I would like to model ENFIA and total holding costs on a Greek property."
/>
...
ENFIA is a product of six factors rather than a flat rate, and only one of them moves the bill materially. The base zone rate, set by the property's location, ranges from €2.00 to €16.20 per square metre and does most of the work. Floor, age, frontage and use multipliers then adjust it, and for typical mid-range residential stock the combined multiplier lands between 1.05 and 1.25. All six are published by AADE in the annual tax tables.
...
Golden Visa applicants purchasing at or above the €800,000 threshold in high-demand zones should explicitly model this supplement, as a single property can already generate substantial supplementary liability. Screening candidates through the [Golden Visa eligible projects directory](/guides/golden-visa-eligible-projects-directory/) keeps the tier and the supplement in the same decision.

## The E9 Declaration: Your Annual Filing Obligation
The E9 is the declaration your ENFIA is calculated from, filed or confirmed through Taxisnet by 31 May each year. It records every property you own with its location, size, type, floor, ownership share and objective value zone. AADE cross-checks it against the national cadastre and title deed records, so a discrepancy is not a private matter: it triggers audits and retrospective assessments. Buying or selling during the year requires an updated E9 within thirty days of the deed.
...
There is no foreigner surcharge and no foreigner exemption: non-residents pay ENFIA on exactly the same terms as Greek nationals. What differs is access. You need an AFM before you can register on Taxisnet or receive an assessment at all, and payment is made online against the assessment reference code, which many European banks will settle by SEPA transfer without a Greek bank account. Instalments of three to six months are permitted.
...
Assume none apply to you. The blanket primary-residence exemption was removed in 2022, and what remains is narrow and means-tested: a reduction of up to 50% for taxpayers with annual gross income below €9,000 who own a single property below a modest objective value. A non-resident owner of a €400,000 Golden Visa apartment falls outside every category, so ENFIA should be budgeted in full from the year of purchase.
...
Investors should model ENFIA alongside all other annual holding costs. The table below illustrates a realistic annual cost stack for two representative properties, and the [Greece property cost calculator](/tools/greece-property-cost-calculator/) runs the same lines against your own budget.
...
For the Mykonos villa, the supplementary ENFIA alone reduces gross rental yield by roughly 0.3 percentage points at typical rental rates, a number that matters when comparing with other jurisdictions. Regional €400K buyers should stress-test annual ENFIA on [Crete Golden Visa stock](/guides/crete-property-investment-guide/) and run the [Golden Visa due diligence checklist](/guides/golden-visa-property-due-diligence-checklist/) before locking a reservation.

<InlineCta
  text="Modelling ENFIA on Crete or regional Golden Visa stock? Tell us your budget and we return three file-ready options with annual hold costs."
  buttonText="Get Golden Visa shortlist"
  buttonHref="/get-shortlist/"
  ctaId="enfia_mid_shortlist"
/>
...
## ENFIA Calculation for a Multi-Property Portfolio in Athens

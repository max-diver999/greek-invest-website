...
description: "French buyers Greece property: Crete vs Côte d'Azur prices, retraite, non-resident tax, what the yield data supports. EU buyers, no GV needed for Schengen."
pubDate: 2026-06-25
...
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/w_1200,q_85,f_webp/more-group/greece/curated/yachts-and-chora-astypalaia-greece-3141889e"
relatedSlugs:
...
faq:
  ...
  - question: "What rental yields can French investors expect in Crete long-term rental market?"
    answer: "Crete's published asking figures support about 4.0% gross for Chania Prefecture on long-term residential leases, not the 5% to 6% that circulates in marketing. Chania and Heraklion offer year-round demand. Yields exceed Athens Riviera at 3.5 to 5.0% and significantly outperform French Riviera LTR at 2.5 to 4.0%."
...
**Quick answer:** French citizens do not need Greek Golden Visa; EU freedom of movement grants automatic residence and property ownership rights. French buyers target Greece for résidence secondaire, retirement, and rental income at capital levels impossible on the Côte d'Azur. Crete delivers 120 to 220 m² coastal villas at €400,000 to €600,000, one-third the price of comparable French Riviera stock. Long-term rental yields are closer than the marketing suggests: about 4.0% gross where Crete can be measured, against 2.5 to 4.0% in French coastal markets. Greek non-resident tax is straightforward under the France-Greece treaty. Transfer costs at 5.5 to 7.5% are lower than French notaire fees. French retirees can relocate full-time with zero bureaucracy beyond municipal registration.

<TldrBlock text="French EU nationals need no visa or residency permit for Greece property. Crete coastal stock at €1,800 to €2,500/m² is 40 to 70% cheaper than French Riviera. Long-let yields near 4% sit at the top of the French coastal range rather than above it. ENFIA property tax €800 to €2,500 annually. French retraités can live in Greece indefinitely with EU residence rights. Golden Visa irrelevant except for non-EU spouse edge cases." />
...
Rental yield dynamics reinforce the arbitrage. Crete long-term residential yields are thinner than the marketing claims: the only measurable figure, Chania Prefecture asking rent against asking price, implies about 4.0% gross. See the [Greece rental yield guide](/guides/greece-rental-yield-guide/) for regional benchmarks. French coastal markets, saturated with second-home stock and compressed by domestic rent control discussions, deliver 2.5 to 4.0% gross yields on comparable assets. For French investors prioritising income over lifestyle, Greece offers a material yield premium in the same currency and legal jurisdiction.
...
The gap is wide enough to be the reason many French buyers look at Greece at all. Cretan long lets imply about 4.0% gross where they can be measured, and Athens transitional districts 6.0% to 7.5%, against French Mediterranean coastal yields that typically sit well below both once acquisition costs of 9% to 13% are amortised. Greek acquisition costs run 7% to 10% on a flat 3.09% transfer tax, so the entry differential compounds the yield differential.
...
| --- | --- | --- | --- |
| Crete (Chania Prefecture) | ~4.0% implied, asking data | Professionals, students, families | Low year-round |
...
EU citizenship removes two steps that dominate non-EU timelines: there is no Pink Slip requirement and no Ministry of Defence border-zone clearance. What remains is identical for everyone, and French buyers should not read the lighter administrative load as a lighter diligence load. The AFM, the twenty-year title search, the engineer certificate and the 7% to 10% cost stack all apply exactly as they do to a non-EU purchaser.
...
Many French retraités and second-home buyers prefer long-term residential leases over STR to avoid management burden and seasonal volatility. Crete long lets deliver stable occupancy and lower tax compliance complexity, at an implied gross near 4.0% rather than the 5% to 6% often quoted. French buyers letting on twelve-month leases file simpler Greek tax returns and avoid EOT licensing requirements.
...
| LTR yields near 4.0% vs 2.5 to 4% French coastal markets | Language barrier outside Athens and tourist zones |
...
Recommendation: Target a 140 to 180 m² villa in Apokoronas or Rethymno periphery with three bedrooms, outdoor terrace, and beach proximity. Model personal use for six weeks annually, long-term lease during off-season at about 4.0% gross. Execute purchase via French-speaking Greek lawyer. Budget ENFIA at €1,200 to €2,200 annually.
...
French buyers arrive with confidence from a notarial system that looks superficially similar and works differently in one crucial respect: the Greek notary does not perform buyer-side diligence. The most common consequence is skipping cadastre verification, where marketing square metres routinely include terraces and parking. Confirm that κύριος χώρος, the main usable area, matches expectations before the deposit, not at the deed.

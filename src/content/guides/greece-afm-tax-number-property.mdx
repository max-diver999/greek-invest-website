...
The pink slip is the registration certificate a Greek tax office issues to a foreign national without a Greek address (αποδεικτικό εγγραφής μη κατοίκου). It does two things: it confirms your non-resident status for Greek tax purposes, and it names a Greek fiscal representative who accepts correspondence on your behalf, usually your lawyer. Notaries will not execute a deed for a non-resident buyer without it, which makes it a scheduling item rather than a formality.
...
The AFM process itself is identical regardless of why you are buying; the differences appear downstream. A buyer purchasing for personal use or general investment is not bound by the Circular 1/2026 requirement to route the full purchase price through a traceable Greek account, though a Greek account remains practically necessary for ENFIA, utilities and rent. The Golden Visa applicant has no such flexibility: the fund trail is part of the application.
...
Most AFM delays are clerical rather than substantive, and one cause dominates: name spelling. The passport transliteration on the power of attorney, the utility bills and the DOY submission must match exactly, and a missing middle name or a differently transliterated surname sends the file back for a fresh appointment. Standardise the spelling across every document before submission, and check the proof-of-address document is recent enough for the office handling it.

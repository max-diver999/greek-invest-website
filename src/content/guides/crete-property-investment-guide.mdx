...
Recommendation: Target Heraklion suburbs or Chania Akrotiri / Apokoronas where €2,000 to 2,300 per square metre delivers 170 to 200m² with pool or garden. Underwrite 5 to 6% LTR gross. Do not model STR on the GV file. Check the size against the submarket table above before committing.

...
readingTime: 14
heroImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/Glyfada_Marina_-_panoramio.jpg/1280px-Glyfada_Marina_-_panoramio.jpg"
relatedSlugs:
...
faq:
  ...
  - question: "How does Glyfada connect to central Athens?"
    answer: "The Athens Tram (Line T5) runs through Glyfada along the coastal boulevard, linking the suburb to central Athens in roughly 45–55 minutes depending on stop and time of day. Glyfada also sits on the main coastal road toward Ellinikon and Voula, with taxi rides to Elliniko metro station typically under fifteen minutes in off-peak traffic."
  - question: "Is Glyfada affected by the Athens short-term rental moratorium?"
    answer: "The 2025–2026 Athens STR moratorium targets heavily saturated central districts such as Kolonaki, Monastiraki and parts of Piraeus city centre. Glyfada and the wider Riviera are not typically treated the same way for new STR licence saturation. However, Golden Visa qualifying properties cannot use STR regardless of local licensing rules."
...
<TldrBlock text="Glyfada is the commercial heart of the Athenian Riviera and sits in Greece's €800,000 Attica Golden Visa zone. Expect €4,000–5,500/m² on quality stock, LTR gross yields of 4.5–5.5%, tram access to Athens, and a marina lifestyle. STR is banned on the qualifying GV asset. The 120m² rule is manageable here at €800K but verify usable area on every file." />
...
Underwriting a Golden Visa purchase using Airbnb gross yields of 7–9% — still quoted anecdotally for non-GV Athens stock — is a compliance error on the qualifying asset. The [Greece rental yield guide](/guides/greece-rental-yield-guide/) compares net frameworks across cities; use LTR rows for Glyfada planning.

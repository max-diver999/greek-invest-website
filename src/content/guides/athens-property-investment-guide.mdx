...
Athens city-wide gross yield averages 5.43%. In districts such as Kipseli, well-located apartments can reach 6 to 7.5% gross on long-term residential tenancies. Net yields after ENFIA property tax, management fees of roughly 8 to 12% of rent, maintenance, insurance, and progressive income tax starting at 15% land 1 to 1.5 percentage points below gross. A 6.5% gross Kipseli yield realistically becomes a 5.0 to 5.5% net yield, still competitive with Western European capitals.

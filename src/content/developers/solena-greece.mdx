...
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/greece/heroes/solena-greece-e423f5e4.webp"
heroAlt: "Solena apartment building among pine trees near Sounio"
relatedSlugs:
...
## Who is Solena and what is the ΕΛΑ brand?
...
Every Solena scheme in the Attica regional unit inherits the €800,000 threshold and the 120 m² certified main usable area minimum on a single deed, and the ΕΛΑ suites format is where those two rules collide most often. Suites are marketed on view, finish and furnishing rather than floor area, so a unit can reach a compliant price at a non-compliant size: in Kastella and Mikrolimano, where the market runs at roughly €3,800 per square metre and above, €800,000 implies about 210 square metres at the prevailing rate, but a furnished premium suite can hit the threshold at 90 or 100 square metres and fail the file. Outer Piraeus stock at around €2,400 per square metre has the opposite problem, delivering size easily and price rarely. Budget roughly €856,000 to €880,000 all in on a qualifying Attica deed, and read the engineer's certificate rather than the brochure on every unit.

## Key projects: Piraeus, Kallithea, and Papagos


Solena builds in three Attica clusters, and they are not interchangeable for a Golden Visa buyer. Piraeus is the densest footprint and the widest price range, from about €2,400 per square metre on outer stock to €3,800 or more in Kastella and Mikrolimano. Kallithea is the value corridor with metro access. Papagos is the quiet northern suburb where unit sizes clear 120 m² most easily.
### Piraeus cluster
...
Isminis Kallithea targets the inner coastal municipality between central Athens and the Riviera. Kallithea trades roughly €2,800 to 4,200 per square metre on quality stock with no published district yield series, a middle-ring profile detailed in the [Kallithea property investment guide](/areas/kallithea-property-investment/).

Solena's Kallithea entry competes against 1970s to 1990s resale that foreign buyers renovate. The trade-off: known title and immediate lease versus new systems and off-plan timeline risk. At €800,000 in Attica, Kallithea usually delivers comfortable margin above the 120m² floor, unlike ultra-premium Riviera quotes where size tightens.
...
Every Solena scheme sits in Attica, which means the €800,000 tier applies to all of them with no regional alternative. The practical tension is that boutique suite formats often price below the threshold individually and measure below 120 m² of usable interior, so a Solena unit qualifies only when a single deed clears both tests on its own.
...
## How are Solena payments staged?
...
| Structural milestone | 30 to 40% | Site visits + engineer reports |
...
Solena stages payments across reservation, permit approval, construction milestones and the deed, in line with standard Attica practice: roughly 5% to 15% at reservation, 20% to 30% on the permit being issued, 30% to 40% at a structural milestone and the balance on completion. On an €800,000 qualifying unit that leaves €440,000 to €680,000 with the developer before any ownership transfers, and Greek law secures none of it, because there is no national escrow requirement for off-plan residential sales. Negotiate a bank guarantee per tranche, a contractual delivery date with financial penalties, and a refund right if the building permit is revoked or materially amended. On furnished ΕΛΑ suite formats, also require the deed to separate the property price from the furniture package, because only the property counts toward the €800,000 threshold.
...
- **Timeline slippage:** June 2026 targets can slip 6 to 18 months industry-wide; migration plans need buffer.
...
**Scenario C, Kallithea commuter play.** Target professionals using Line 2. Isminis Kallithea must beat inland 1990s stock on rent per euro of purchase after accounting for off-plan wait and ENFIA. Model voids at 5 to 8% annually.

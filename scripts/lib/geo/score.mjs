...
import { buildCorpusIndex, analyseDoc, plainText, words, sentences, canonicalFigure, FIGURE_RE } from './corpus-signals.mjs';
...
function scoreProvenance(docId, index) {
  ...
  // FIGURE_RE and canonicalFigure are imported rather than restated: this
  // pattern existed in three copies, and the euro port had to edit each one.

...
For the Mykonos villa, the supplementary ENFIA alone reduces gross rental yield by roughly 0.3 percentage points at typical rental rates, a number that matters when comparing with other jurisdictions. Regional €400K buyers should also stress-test annual ENFIA on [Crete Golden Visa stock](/guides/crete-golden-visa-400000-property/) before locking a reservation.

<InlineCta
  text="Want ENFIA plus transfer tax and closing costs in one sheet? Book a scenario call and we model the annual stack on your shortlist."
  buttonText="Book a cost review"
  buttonHref="/greece-property-consultation/"
  ctaId="enfia_mid_consultation"
/>

...
tags:
  ...
  - "piraeus developer"
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/greece/heroes/greca-developments-f4bfe2f1.webp"
heroAlt: "Render of a modern apartment building by Greca Developments"
relatedSlugs:
...
Central Athens new-build supply is scarce relative to demand from foreign professionals, Golden Visa filers, and domestic upgraders leaving older polykatoikia blocks. Developers like Greca Developments fill infill sites with small schemes, often 20 to 40 units, rather than Ellinikon-scale masterplans.
...
## What is 3S Athens, and when does it deliver?
...
## What else is in Greca's pipeline?
...
## Do Greca units qualify for the €800,000 Attica tier?
...
## How are payments staged on a Greca off-plan unit?
The economics of Greek off-plan are simple and unforgiving: you fund construction, and title transfers only at the deed. Greca stages payments through reservation, permit-linked tranches, construction milestones and the deed balance, which is standard. What is not standard, and what you have to ask for, is a bank guarantee covering each tranche. Without one, a pre-permit payment is unsecured exposure to a single-project company.
...
3S Athens is marketed for 2027 delivery, which puts the VAT question ahead of everything else in the payment schedule. The new-build VAT suspension currently runs only to 31 December 2026, and the applicable rate is the one in force on the day the deed is signed rather than the day the contract is signed, so an €800,000 unit completing in 2027 without a renewal faces 24% VAT of €192,000 in place of a 3.09% transfer tax of about €24,720. That €167,280 difference has to be allocated explicitly in the preliminary agreement. On the tranches themselves, expect 5% to 15% at reservation and staged payments against permit and construction milestones, none of it secured against the property under Greek law unless a bank guarantee is contracted for each tranche.
...
Two risks account for most off-plan losses and both are contractual rather than commercial. A permit revision that reduces the delivered unit size can push a property below the 120 m² threshold after you have paid, so the contract needs a price adjustment mechanism or an exit right tied to certified area. And developer SPV insolvency is survivable only if bank guarantees are in place and pre-permit cash is limited: a claim against an empty project company is worth nothing.
...
Two profiles buy 3S, and their timelines pull in opposite directions. A Golden Visa buyer must align the reservation with a completion buffer, because the permit clock starts at the deed and runs eight to fourteen months after it, so a 2027 completion means a 2028 permit. A long-let investor should compare the off-plan rent projection against an immediate lease on resale stock in the same postcode, and discount the off-plan figure for two years of foregone income and delivery risk.
...
On a premium specification the checks that matter are the ones nobody performs until something fails. Get manufacturer warranty certificates for the VRV heat pumps, underfloor heating manifolds and smart-home controllers, transferred into your name rather than left with the developer. Then the finishes schedule annexed to the contract, the certified usable area on the engineer certificate, the habitation certificate as the trigger for final payment, and a snagging holdback at deed.

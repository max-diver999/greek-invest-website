...
description: "Greece capital gains tax on property is suspended to 31 Dec 2026. How CGT works, exemptions, rates when reinstated, and what it means for your investment."
pubDate: 2026-06-17
...
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/greece/heroes/greece-capital-gains-tax-property-575fbec9.webp"
heroAlt: "Colonnade of the Stoa of Attalos in the Ancient Agora, Athens"
relatedSlugs:
...
Greek capital gains tax on property disposals by individuals is 15% on the gain, and it has been suspended continuously since 2013, most recently through 31 December 2026. A seller completing inside the suspension window therefore pays nothing on the gain itself. What still has to happen is administrative rather than fiscal: AADE will not issue the tax clearance certificate the notary requires while ENFIA is outstanding, E9 declarations are unfiled, or tax on past rental income is unpaid, and the notary cannot complete without that certificate. Two planning consequences follow. First, the suspension is a policy choice a future budget can reverse, so any investment case that only works with CGT at zero should be modelled at 15% as well. Second, sellers who have let the property and not declared the income discover the problem at the clearance stage, roughly two weeks before a completion date that has already been agreed.

## How CGT Is Calculated When the Suspension Ends


Worth modelling now, because the suspension is a renewable policy rather than a repeal. Under the Income Tax Code as written, the taxable gain is the sale price less acquisition cost, acquisition taxes, documented improvements and an inflation adjustment, taxed at 15% for individuals. Keep the deed, the transfer-tax receipt and every renovation invoice from the day you buy, because those deductions are only available if they are documented.
...
If the suspension lapses, capital gains tax on a property disposal by an individual is 15% of the gain, calculated as sale price less acquisition price less documented improvement costs, with an inflation-indexation coefficient applied to the acquisition price by holding period. Two features matter for planning now rather than later. Documented improvements reduce the taxable gain, which means contractor invoices and building permits from a renovation are worth retaining for the life of the ownership; buyers who renovate without keeping the paperwork lose the deduction entirely if CGT is reinstated. And the indexation coefficient rewards long holds, so the effective rate on a fifteen-year holding is materially below 15% of the nominal gain. A property bought at €400,000 and sold at €520,000 shows a €120,000 nominal gain and an €18,000 charge before indexation and improvements.
...
On the gain itself, effectively nothing, while the suspension holds. What still has to happen before a sale can complete is administrative rather than fiscal: AADE will not issue the tax clearance certificate (φορολογική ενημερότητα) the notary requires if you have outstanding ENFIA, unfiled E9 declarations or unpaid rental income tax. Sellers who have let the property and not filed discover this at the worst possible moment.
...
## Exit Strategy and Capital Gains Tax Suspension in 2026


This example shows the size of the benefit and the fragility of it. On a €300,000 gain the suspension meant €0 of Greek capital gains tax rather than €45,000 at the statutory 15%, leaving the full amount available for reinvestment. The tax has been suspended repeatedly since 2013 rather than abolished, and your home country may tax the same gain regardless, which for Americans and Australians means no Greek tax paid also means no foreign tax credit to claim.

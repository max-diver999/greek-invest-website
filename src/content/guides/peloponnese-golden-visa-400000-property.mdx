...
faq:
  ...
  - question: "How long does the Greek Golden Visa application take in 2026?"
    answer: "The property purchase completes in 60 to 90 days. Permit processing at the Ministry of Migration adds a further 8 to 14 months due to the backlog. Total time from first viewing to permit-in-hand is typically 12 to 18 months."
  - question: "Does Nafplio qualify for the €400K Golden Visa threshold?"
    answer: "Yes. Nafplio is in the Argolida regional unit of the Peloponnese and is not classified as a high-demand zone. The €400,000 single-property minimum applies, though Nafplio's premium old-town asking prices of €2,400 to 2,800/m² mean buyers need 143 to 167m² to qualify."
---
...
|---|---|---|---|
| Short-term rental (Airbnb/VRBO) | No | 7 to 9% gross (unlicensed = illegal) | GNTO licence and GV registration are mutually exclusive |
| Long-term rental (12-month lease) | Yes | 4 to 5% gross | Patra benchmark ~4.81% per Global Property Guide |
| Seasonal furnished let (2 to 6 months) | Conditional | 3 to 4% gross | Must not be operated as a licensed STR platform listing |
...
5. **Land registry registration**: completed 30 to 60 days after notarial signing; Golden Visa application cannot proceed until this is confirmed
...
| Notary fees | 1.0 to 1.5% of contract price | Regulated tariff in Greece |
| Lawyer fees | 1.0 to 1.5% of contract price | Non-negotiable for GV transactions |
| Real estate agent commission | 2.0 to 4.0% (buyer side) | Often 2% if agent represents buyer exclusively |
| Land registry fee | €1,000 to 2,500 | Fixed plus variable component |
| Golden Visa application fee | €2,000 per adult applicant | State fee; €1,000 per dependent under 21 |
| Greek health insurance (annual) | €1,200 to 3,500/year | Mandatory for permit validity |
| Annual property tax (ENFIA) | €600 to 2,500/year | Based on cadastral value; Peloponnese rates generally lower than Athens |
...
## Risks and red flags in the Peloponnese


The Peloponnese offers the most square metres per euro in the €400,000 tier, and the reasons it does are also its risks: rural title that has passed through inheritance without a clean cadastre entry, plots that overlap the forest registry, and village stock with shared access that was never formalised. All three are resolvable, and resolution runs in months or years rather than weeks.
The region offers the best square-metre value in the €400,000 tier, and the risks follow from the same rural character.

- **Cadastre gaps in village stock.** Inherited rural property frequently has an incomplete ownership chain, unregistered heirs, or unknown owner status. Resolution runs 12 to 24 months through the courts.
- **Forest registry overlap.** Plots adjoining woodland can be partly classified as forest, which freezes the sale until the Forestry Commission rules. That process runs 18 to 36 months.
- **Unpermitted extensions.** Additions built over decades without permit are common. Some are legalisable under Law 4495/2017 with a fine; some are not.
- **Seasonal tenant depth.** Long-term letting is mandatory on a Golden Visa asset, and inland Peloponnese towns have thinner year-round rental demand than Kalamata or Nafplio. Underwrite the void, not the peak.
...
<FaqBlock items={[
  ...
  },
  {
    ...
    answer: "Buyers should budget 8 to 12% above the purchase price for transaction costs: property transfer tax at 3.09% of cadastral value, notary fees of 1 to 1.5%, lawyer fees of 1 to 1.5%, real estate agent commission of 2 to 4%, land registry fees of €1,000 to 2,500 and the Golden Visa application fee of €2,000 per adult (€1,000 per dependent under 21). Annual ENFIA property tax in the Peloponnese typically runs €600 to 2,500 per year depending on cadastral value."
  }
]} />

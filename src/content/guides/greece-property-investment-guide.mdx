...
Greece in 2026 is a good residency purchase and a mediocre income one, and the distinction matters more than any regional recommendation in this guide. On the income side, national gross yields average 4.40% and Athens 5.43%, but Greek rental income tax is charged on gross rent at 15%, 25%, 35% and 45% by band with only a flat 5% repairs deduction, and once ENFIA, management and vacancy are added a 5.4% gross typically nets 1.7% to 3.0%. On the residency side the arithmetic is unusually strong: one deed at €400,000 in regional Greece covers a spouse, children under 21 and the parents of both spouses, with no minimum stay to hold or renew the permit. Foreign capital inflows fell 25.3% in 2025 while transaction volumes held, which is a better negotiating environment than the preceding three years offered.
...
| Crete (tourist zones) | Seasonal short-term, licence-dependent | Long lets imply about 4.0% in Chania Prefecture |
| Rhodes / Dodecanese | Seasonal short-term, no published series | High season revenue, border-zone checks for non-EU |
...
Greek gross yields run 4.40% nationally and 5.43% across Athens, with the spread inside Athens wider than the spread between Greek cities. Working-class districts such as Kypseli, Patisia and Peristeri reach 6.0% to 7.5% gross on stock priced at €1,200 to €2,000 per square metre. Thessaloniki is measured at 4.4%, level with the national average and below Athens. On Crete the only measurable figure is Chania Prefecture, where published asking rent against published asking price implies about 4.0%; Heraklion publishes no rent series. The Athenian Riviera runs 3.8% to 4.5%, and premium Cycladic islands 2.5% to 4.5% because prices are high relative to year-round tenant demand. Every one of those is a pre-tax, pre-expense ratio. Greek rental income tax applies to gross rent at 15%, 25%, 35% and 45% by band with only a flat 5% repairs deduction, and net yields typically land 40% to 55% below the gross headline.
...
| Crete | €400K tier and square metres per euro | €400,000 | Residency efficiency, not yield |
...
## Risks and red flags across the Greek market


Five risks apply everywhere in Greece regardless of region or tier, and the largest is arithmetic rather than legal: rental tax charged on gross rent from the first euro, which turns a 5.4% gross yield into something between 1.7% and 3.0% net. The other four — title and cadastre defects, unpermitted construction, the Golden Visa short-term rental ban, and the tier boundaries themselves — are all knowable before a deposit.
Five risks apply regardless of which region or tier you choose.

- **Net yield is far below gross.** Rental tax from the first euro, ENFIA, management and vacancy typically compress a 5.4% gross yield to between 1.7% and 3.0% net. Any model built on the gross figure is wrong by roughly half.
- **Title and cadastre defects.** Unknown owner status, pending corrections and forest-registry overlaps each freeze a sale for months or years. All are visible to a lawyer before the deposit and invisible in a listing.
- **Unauthorised construction.** Extensions without permit are widespread. Some are legalisable, some face demolition; only an engineer survey distinguishes them.
- **Short-term rental regulation.** The Athens centre moratorium and the Golden Visa STR ban both remove income streams buyers assume are available.
- **Currency and exit.** The market is euro-denominated and capital gains tax is suspended rather than abolished. Model the exit at today's rules and stress-test the suspension ending.

...
Run at net rather than gross, both options land well under the yields quoted for cheaper Athens stock, and for the same reason: Greek rental income is taxed progressively at 15%, 35% and 45% on gross rent with no expense allowance, so an €800,000 asset pays the top rate on most of its income. Modern Riviera stock with parking and a good energy rating nets around 2.1%. A renovated 1970s Kolonaki flat nets closer to 1.5%, because prime capital value does not translate into proportionally higher rent and the maintenance reserve on older stock is real.
...
| Greek rental income tax (15/35/45%) | €9,780 | €13,000 |

...
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/greece/heroes/off-plan-property-greece-guide-49a127aa.webp"
heroAlt: "Render of a new-build apartment block by Greca Developments"
relatedSlugs:
...
While the suspension holds, an off-plan Greek home is taxed like a resale: 3.09% transfer tax, not 24% VAT. On a €500,000 purchase that is €15,450 instead of €120,000. The suspension runs to the end of 2026 and the exposure falls on whoever's deed completes after it, which makes the date the deed is signed, not the date the contract is signed, the one to negotiate.
...
The risks that matter in off-plan are the ones a standing property cannot have: the developer failing before delivery, the delivery date slipping 12 to 24 months, and the specification arriving different from the one you signed for. A bank guarantee or notarised escrow turns the first from a total loss into a recoverable one. Nothing turns the second and third into anything except contract language agreed before the deposit.
...
Snagging is the last point at which the developer still has a commercial reason to fix anything, so it happens before the final payment and before the handover protocol is signed, and it is done by your engineer rather than theirs. Budget half a day for an apartment, and hand over the defect list in writing on the day rather than emailing it a week later.

...
Greek gross yields run 4.40% nationally and 5.43% across Athens, with the spread inside Athens wider than the spread between Greek cities. Working-class districts such as Kypseli, Patisia and Peristeri reach 6.0% to 7.5% gross on stock priced at €1,200 to €2,000 per square metre. Thessaloniki runs 5.0% to 6.5% on student-adjacent inner stock. Crete's Chania and Heraklion deliver 5% to 6%. The Athenian Riviera runs 4.5% to 5.5%, and premium Cycladic islands 2.5% to 4.5% because prices are high relative to year-round tenant demand. Every one of those is a pre-tax, pre-expense ratio. Greek rental income tax applies to gross rent at 15%, 25%, 35% and 45% by band with only a flat 5% repairs deduction, and net yields typically land 40% to 55% below the gross headline.

...
Greek AFM registration for non-residents typically produces a pink slip naming a fiscal representative in Greece, almost always the buyer's lawyer, while residents receive a standard certificate without that representative block on the same nine-digit AFM number.

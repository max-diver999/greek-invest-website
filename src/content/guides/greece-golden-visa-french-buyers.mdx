...
The gap is wide enough to be the reason many French buyers look at Greece at all. Cretan city long lets run 5% to 6% gross and Athens transitional districts 6.0% to 7.5%, against French Mediterranean coastal yields that typically sit well below both once acquisition costs of 9% to 13% are amortised. Greek acquisition costs run 7% to 10% on a flat 3.09% transfer tax, so the entry differential compounds the yield differential.

...
Seven deductions stand between gross and net, and Greek rental income tax is much the largest. It applies from the first euro with no allowance: 15% up to €12,000 of annual rent, 35% from €12,001 to €35,000, and 45% above that. On a €150,000 Athens apartment letting for €8,000 a year, that alone removes €1,200 before ENFIA, management, vacancy, maintenance, insurance or accountancy are counted.
...
The numbers below show why the distinction is not academic. A €150,000 Athens apartment at a 5.4% gross yield produces €8,100 of rent and roughly €5,485 of annual costs, compressing the headline figure to about 1.7% net in a conservative base case. On newer stock with tighter vacancy and lower maintenance the same property reaches 2.5% to 3.0%. The swing variable is the maintenance reserve, which can be deferred but not avoided indefinitely.
...
| Accountant fees | −600 |
| **Net rent after all deductions** | **+2,615** |
| **Net yield on purchase price** | **1.74%** |

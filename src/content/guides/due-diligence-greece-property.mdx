...
readingTime: 15
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/w_1200,q_85,f_webp/more-group/greece/curated/naxos-chora-2020-08-20-34-portara-blues-star-fer-71ebcf15"
relatedSlugs:
...
faq:
  ...
  - question: "How much does a Greek property engineer survey cost?"
    answer: "An independent engineer survey in Greece, covering measurement verification, building permit compliance, and the Electronic Building Identity certificate, costs between €300 and €800 depending on the property's size, age, and complexity. For Golden Visa applications the engineer certificate is mandatory rather than optional, as it documents the usable area that must meet the 120m² minimum."
  ...
  - question: "Is a lawyer legally required to buy property in Greece?"
    answer: "A lawyer is not legally mandatory in every Greek transaction, but no serious foreign buyer should proceed without one. A notary is required to authenticate the deed but represents neither party, their role is document validity, not buyer protection. Your lawyer conducts the title search, verifies cadastre status, checks for encumbrances and ENFIA arrears, reviews the preliminary agreement, confirms border zone status, and verifies Golden Visa tier compliance if applicable. Legal fees run 1% to 2% of the purchase price, the most valuable money spent in a Greek transaction."
...
Run this before spending anything else, because a negative answer ends the purchase rather than complicating it. Designated border zones cover the eastern Aegean islands facing Turkey, the northern land frontiers with Albania, North Macedonia and Bulgaria, and parts of Thrace and the Dodecanese. Non-EU buyers need Ministry of National Defence clearance there, which adds three to six months and must be a contractual condition rather than an assumption.
...
Greek engineer surveys are planning-compliance checks, not condition reports, and they produce three outputs that matter legally: verified measurement of usable area, comparison of the physical building against every permit on record, and the Electronic Building Identity without which the property cannot transfer. At €300 to €800 this is what establishes whether a property clears 120 m² and whether any extension is legalisable or facing demolition.
...
The tier follows the cadastral parcel, not the postal address, and getting it wrong is the most expensive routine error in the current market. Attica, the whole Thessaloniki Regional Unit, Mykonos, Santorini and islands over 3,100 residents require €800,000; everywhere else €400,000. Municipal boundaries run through streets that share a marketing name, so verify the parcel before the reservation rather than trusting the listing.
### Zone Classification
...
<FaqBlock items={[
  ...
  {
    question: "How much does a Greek property engineer survey cost?",
    answer: "An independent engineer survey in Greece, covering measurement, building permit compliance, and the Electronic Building Identity certificate, costs €300 to €800 depending on property size and complexity. Standard apartments under 100m² run €300 to €450. Villas and properties over 200m² run €550 to €800. For Golden Visa applications the engineer certificate is mandatory, not optional, as it documents the usable area that must meet the 120m² minimum under Law 5100/2024."
  },
  {

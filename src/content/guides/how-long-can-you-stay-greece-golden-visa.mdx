...
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/greece/heroes/how-long-can-you-stay-greece-golden-visa-8fa40622.webp"
heroAlt: "Turquoise bay on the coast of Corfu"
featured: false
faq:
...
A Greek Golden Visa permits unlimited residence in Greece: you may live there 365 days a year, or never visit after the biometric appointment, and both are equally compliant. There is no minimum stay to hold the permit and none to renew it every five years. Three separate clocks run alongside that freedom and none of them is affected by it. Elsewhere in the Schengen area the permit gives 90 days in any rolling 180, the same as a visa-free visitor. Greek tax residence attaches at 183 days in a calendar year, which is a liability rather than a right and arrives whether or not you wanted it. And naturalisation requires seven years of genuine physical residence, so the buyer who never visits accrues no time toward citizenship at all, however long the permit has been held.

## Schengen Travel: What the Biometric Card Actually Gives You
...
The biometric residence card gives unlimited presence in Greece and 90 days in any rolling 180 across the other 28 Schengen states, which is the same allowance a visa-free visitor receives. It does not give the right to work or reside in another member state, it does not extend the 90-day allowance, and it does not exempt the holder from the Entry/Exit System recording their crossings. What it does change, for a passport that otherwise needs a Schengen visa for each trip, is that the application disappears: entry is on the card. Days spent in Greece do not count against the 90-in-180 allowance for the rest of the area, so a holder can spend six months in Greece and still have the full allowance for travel elsewhere in the same period.
...
## Permit Stay vs Citizenship Presence: The Critical Distinction
...
## Greece vs Portugal: Minimum Stay Comparison


The two programmes differ sharply here, and it is the clearest practical distinction between them. Greece imposes no minimum stay at all: the permit renews on the investment being maintained, regardless of how many days you spend in the country. Portugal's ARI requires an average of seven days per year, which is light but not zero, and that presence requirement is what feeds its shorter naturalisation clock.
...
## Bridging Documents During the Application Period
...
## Family Members: Same Stay Rules, Linked Status


Family permits are derivative, which cuts both ways. A spouse or registered partner, dependent children and dependent parents included on the main application receive permits tied to the same qualifying investment, with the same zero-stay position and the same five-year renewal cycle. The linkage means that if the main applicant's permit lapses, whether through selling the property or breaching the short-term rental ban, every derivative permit lapses with it.
...
## Pros and Cons of Greece's Zero Minimum Stay Rule
...
## Stay and Travel Mistakes to Avoid
...
## Buyer scenarios: who the Zero-Stay Rule Serves Best

Zero minimum stay suits three profiles and actively misleads a fourth. It is ideal for the investor who wants EU optionality without relocating: track renewal dates, keep the property compliant, and stay under 183 days a year to avoid becoming a Greek tax resident. It suits the family using the permit for school access and Schengen travel. It does not suit the buyer whose real goal is citizenship, because naturalisation needs genuine physical residence that permit-holding alone never accumulates.
...
## Risks and red flags around stay requirements


There is no minimum stay to hold or renew a Greek Golden Visa: zero nights a year is compliant. The risk is entirely in what people infer from that. Citizenship needs seven years of genuine physical residence, the permit gives you 90 days in any 180 elsewhere in Schengen rather than unlimited movement, and tax residence follows days spent, not permits held.
The zero-stay rule is the programme's most attractive feature and its most commonly misread one.

- **No minimum stay for the permit is not the same as no requirement for citizenship.** Renewal needs only the investment maintained. Naturalisation after seven years needs genuine physical residence, and time spent outside Greece does not count toward it. Buyers routinely assume the two clocks are the same.
- **Tax residence follows presence, not the permit.** Spend more than 183 days a year in Greece and you become a Greek tax resident on worldwide income, whether or not that was the plan. The permit itself triggers nothing; your calendar does.
- **The permit does not grant Schengen residence rights elsewhere.** It allows visa-free travel within Schengen at 90 days in any 180, the same allowance a tourist has. It is not a right to live in another member state.
- **Losing the investment loses the permit.** Selling the qualifying property, or letting it short-term in breach of Law 5100/2024, puts renewal at risk regardless of how long you have held the permit.

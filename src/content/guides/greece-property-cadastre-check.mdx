...
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/greece/heroes/greece-property-cadastre-check-6822a5e4.webp"
heroAlt: "Aerial view of the rooftops of Monemvasia"
relatedSlugs:
...
You can run a useful preliminary check yourself in under five minutes, free, at ktimatologio.gr. Searching by KAEK parcel identifier or coordinates returns the registered owner and ownership percentage, the parcel area, any encumbrance flags visible in the database, and the cadastral zone and completion status. That is enough to reveal an unknown-owner registration or a transition zone immediately, which is exactly what you want to know before paying for anything.
...
Five separate documents make up a full cadastre check, and none substitutes for another. The ownership certificate confirms the registered owner, KAEK and parcel area; the encumbrance certificate confirms no mortgages, liens or attachments; the cadastral diagram shows boundaries and adjacent parcels; the owner declaration copy is the original registration claim; and in Land Registry areas a mortgage register search establishes the twenty-year title chain. Together they cost a few hundred euros and take days.
...
A cadastre check produces four documents and each answers a different question. The ownership extract (απόσπασμα κτηματολογικού φύλλου) names the registered owner and any co-owners with their shares. The cadastral diagram (απόσπασμα κτηματολογικού διαγράμματος) fixes the parcel boundaries and its ΚΑΕΚ identifier. The encumbrance record shows mortgages, pre-notations, seizures and pending claims. And the registration status shows whether the property is fully registered, provisionally registered, or recorded with the State as unknown owner, which blocks a sale until a court corrects it. A standard search costs €50 to €150; a full twenty-year title history through a lawyer costs €200 to €500 in professional time. Registration of your own deed afterwards is charged at 0.475% to 0.65% of objective value plus VAT.

## What Does Unknown Owner Status Mean, and How Is It Resolved?
Unknown owner status is a legal freeze rather than a claim by the State. When a municipality first joined the cadastre programme, owners had a three to twelve month window to file a declaration, and any parcel where no valid declaration arrived was registered with the Greek State as provisional owner. The property cannot be sold, mortgaged or transferred until a court resolves it, which typically runs 12 to 24 months and requires historic deeds, inheritance records and tax declarations.
...
## What Happens If the Forest Registry Overlaps Your Plot?
...
Resolution time is what separates a delay from a dead deal. An undischarged mortgage clears in days if the seller simply pays it off, and a pre-notation lifts in one to four weeks. A pending correction application runs six to eighteen months, unknown owner status 12 to 24 months, and a forest registry overlap 18 to 36 months through the Forestry Commission. Any of the last three means the property cannot complete on a normal purchase timetable.
...
You own the property from the moment the deed is signed, not from the moment the cadastre records it, and the gap between the two is normal. In Land Registry areas the deed is recorded in the mortgage register within one to five working days. Where the property is entering the cadastre for the first time, add 20 to 40 working days, because the unit is being created digitally as well as transferred, which also triggers the higher 0.65% registration fee.
...
## How Much Does Cadastre Registration Cost?
The difference is small in percentage terms and material in cash. A property already in the cadastre attracts 0.475% of declared deed value, roughly €1,900 on a €400,000 purchase. The same property entering the cadastre for the first time attracts 0.65%, about €2,600. The fee is paid at the cadastre office before the deed is submitted for registration, and it sits on top of transfer tax and notary fees rather than inside them.
...
## Where Does the Cadastre Check Fit in Due Diligence?

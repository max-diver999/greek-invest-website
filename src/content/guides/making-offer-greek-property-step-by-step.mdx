...
Begin with viewings, in person if possible or via video supplemented by a local representative for remote buyers. During this stage your goal is to assess the property and gather the data points your lawyer will need.
...
- All **conditions precedent** that must be satisfied before completion
...
Golden Visa applicants face additional pre-offer requirements that ordinary buyers do not. Failing either the value threshold or the 120 sqm built area test after signing a preliminary agreement may result in losing your deposit and purchasing a property that does not qualify for Greek residency.
...
Golden Visa residency applications are filed after the deed is registered, not before. The Greek residency card takes additional months to process after filing, but the registered deed is sufficient evidence of your qualifying investment while the card is pending.

## Red Flags That Should Stop the Deal

Certain behaviours from sellers, agents, or intermediaries signal that a transaction carries legal or financial risk serious enough to reconsider entirely.
...
Use this matrix to decide how aggressively to negotiate and which protections to insist on before signing the preliminary agreement.

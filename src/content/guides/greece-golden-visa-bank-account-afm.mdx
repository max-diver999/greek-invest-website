...
Golden Visa property buyers require both a free Greek AFM tax number and a buyer-named Greek bank account before notary deed, because Circular 1/2026 rejects permit files when the €400,000 purchase price is not traceable through that account.
...
AFM registration for non-resident Golden Visa buyers requires a valid passport, proof of foreign address, a Greek fiscal representative AFM, and completed M1 and M7 forms at the DOY, with PoA route adding apostilled authority for remote filing within 14 days.
...
The pink slip means non-resident AFM holders receive a separate DOY certificate confirming fiscal representative appointment, which Greek banks require within 5 to 10 business days of account opening under 2026 KYC rules. Non-resident Golden Visa buyers without a Greek address must present this document alongside passport copies and proof of foreign address dated within 90 days when opening accounts at Alpha Bank, Eurobank, NBG, or Piraeus Bank branches.
...
Circular 1/2026 requires Golden Visa purchase funds to wire from abroad into a buyer-named Greek bank account, then to notary escrow, with 3.09 percent transfer tax paid separately via TAXISnet before deed on a €400,000 taxable base near €12,360.

...
relatedSlugs:
  - "greece-property-market-news-2026"
...
Greece registered 41,743 property transfers in 2025 with a declared value above €4.2 billion, an average of €100,770 a deed. Volume held steady and transfer tax revenue still fell 7.4%, because inter-generational gift transfers rose 13% and those move at reduced tax. Apartments carried the market at 21,354 deals, and Athens took 13.9% of the volume against 14.9% of the value.
...
Athens recorded 5,816 property transfers in 2025 with a combined value of €626 million, which works out at about €107,630 per transaction against a national average roughly 6.8% lower. That premium is structural rather than cyclical: it reflects the weighting of Athens stock toward apartments in serviced urban districts rather than a citywide price spike, and it has not narrowed. Two things follow for a foreign buyer. The average Athens transaction is nothing like the properties in a Golden Visa search, so national and city averages are a poor guide to what an €800,000 file will cost or find. And the depth of that transfer count, nearly 6,000 deals a year in one city, is the liquidity argument for Athens at exit, which no regional market in Greece matches.
...
Gift transfers rose 13% in 2025 because the generation that accumulated Greek urban property between the 1970s and the early 1990s is reaching the age at which it hands that property on, and because gifting to a child now costs far less in tax than an inheritance will. For a foreign buyer this matters in one practical way: much of the resale stock coming to market has just changed hands within a family, which is exactly where incomplete cadastre entries and unsigned co-heirs are found.
...
The registry data says three things worth acting on: Athens carries a structural per-deal premium that is not narrowing, the national average transaction is around €100,000 and therefore nothing like the properties in this guide, and foreign capital inflows fell 25.3% while transaction volumes held. That last combination is what a market looks like when domestic buyers replace foreign ones, and it is a better environment to negotiate in than 2023 was.
...
## Digital Transformation and Land Registry Bottlenecks in 2025

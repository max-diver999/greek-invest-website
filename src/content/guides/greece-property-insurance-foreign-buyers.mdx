...
faq:
  ...
  - question: "How much does property insurance cost in Greece?"
    answer: "Annual premiums for non-resident owners run €200-800+ depending on rebuild value, location and add-ons. A 90 m² Athens apartment costs €250-450 per year for basic buildings cover. A coastal villa insured at €600,000 rebuild value with earthquake extension can reach €800-1,500. Contents, liability, and landlord extensions add €80-300 on top."
  ...
  - question: "Is Golden Visa health insurance the same as property insurance?"
    answer: "No. Golden Visa residency requires private health insurance for the applicant and included family members: inpatient and outpatient cover valid in Greece, at €300-600 per person per year. Property insurance protects the building and contents against physical damage. You need both products for a compliant Golden Visa portfolio: health cover for immigration, buildings cover for asset protection."
...
2. **HOA and developer rules** in gated communities, marina complexes and large off-plan schemes require proof of cover before keys are released.
...
Standard Greek buildings insurance covers fire, explosion, lightning, storm and burst-pipe water escape on the structure, while earthquake damage requires a separate seismic extension priced at 25 to 40 percent above base premium in Attica, Crete, and many Aegean islands. Rebuild value on the schedule, not purchase price, is the critical sum insured figure for non-resident owners.

Greek home insurance (ασφάλεια κατοικίας) is sold as a buildings package with optional contents, liability and catastrophe extensions. The base policy focuses on physical damage to the structure.

| Coverage element | Included as standard | Excluded unless added |
|---|---|---|
| Fire and explosion | Yes | N/A |
| Lightning | Yes | N/A |
| Storm and hail | Yes | Coastal flood needs its own extension |
...
Property insurance for non-resident owners runs €200 to €800 or more per year on mainstream 2026 quotes, with an 85 square metre Athens apartment at €220,000 rebuild value priced €250 to €400 for basic buildings cover and €380 to €550 with earthquake plus contents. Cyclades stone houses at €600,000 rebuild can reach €900 to €1,500 annually when seismic extension is included.
...
Most policies carry a deductible (απαλλαγή) of €500-1,500 per claim. Higher deductibles cut the premium by 10-15% and move that risk onto the owner. For an owner abroad the lower deductible earns its extra €40-80 a year, because arranging emergency repairs from London or Dubai is already costly.
...
Standard Greek fire policies exclude seismic damage. The exclusion is the default, not an option you have to select, so an owner who buys buildings cover and reads no further is uninsured against the one peril the country is known for. A dedicated seismic extension is a separate purchase, priced at 25 to 40 percent of the base buildings premium in high-risk postcodes, and repair costs after a moderate event run past €50,000 on an ordinary Attica or Crete apartment.
...
Earthquake cover pays for structural repair once certified damage exceeds the policy threshold, following an official seismological event and an engineer's assessment. It pays nothing toward preventive retrofitting. The extension is priced at 25-40% of the base buildings premium in high-risk zones.
...
Your personal buildings policy starts on the deed completion date for a resale, and at handover when the final off-plan instalment is paid, while developer contractor all-risk cover protects the construction site only until you become legal owner. Gap risk exists if you take early possession before deed without a written interim insurance clause in the purchase contract.
...
| Snagging period | Transitional: the buyer's, once the deed is signed | Start personal policy at deed even if developer fixes snags |
...
Greek banks lending to residents, and the small number of programmes open to foreign nationals, require buildings insurance before funds are released. Requirements are:
...
Two things change once a tenant moves in: rent stops during a repair, and a stranger's injury on your floor becomes your liability. A landlord package covers both for €100 to €250 a year above standard buildings cover on an Athens apartment, which is small against a month's lost rent. It also fits the Golden Visa constraint better than an Airbnb-oriented policy, because a qualifying deed can only be let on 12-month residential leases and short-let policies are priced for a risk the property is not permitted to run.
...
Golden Visa health insurance and property insurance are separate products serving different regulators, with health cover at €300 to €600 per permit holder per year for immigration compliance while buildings insurance runs €200 to €800 or more per property annually for asset protection. Confusing the two is one of the most common renewal errors non-resident owners make.
...
You can arrange and renew Greek property cover entirely remotely, and most non-resident owners do. Policies run annually with direct debit renewal from a Greek account, and a broker will quote from documentation alone for standard apartment stock. An initial site visit or a surveyor's report helps on unusual properties, stone construction, older villas and anything with a pool, where remote underwriting tends to produce broad exclusions rather than a refusal.
...
3. Declare rebuild value; without an engineer's report the broker applies a €/m² benchmark instead.
...
The insurance trade-off for a foreign owner sets comprehensive buildings plus earthquake cover at €380 to €1,200 per year against cheaper buildings-only policies that satisfy minimum bank requirements but exclude Greece's most catastrophic peril. The checklist below compares the four structures worth evaluating before the first premium payment.
...
The exclusions matter more than the premium, and two of them recur. Earthquake cover is absent from the cheapest policies in a country sitting on an active seismic zone, and flood cover is excluded or heavily limited on ground-floor and basement units in coastal locations. Insist on a written coverage summary table rather than a headline premium, and read the exclusions before comparing prices.
...
Minimum buildings + earthquake from deed; upgrade contents after renovation with revised rebuild value. Tell the insurer before structural works begin; undeclared works void the policy.

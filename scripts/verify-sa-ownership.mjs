#!/usr/bin/env node
/**
 * Verify SA ownership for greek-invest.com via Site Verification API.
 *
 * Usage:
...
const SITE_URL = 'https://greek-invest.com/';
...
async function getToken() {
  ...
  console.log(`  2. Verify file is live: curl https://greek-invest.com/${token}`);

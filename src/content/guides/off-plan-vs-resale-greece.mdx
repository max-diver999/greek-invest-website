---
title: "Off-Plan vs Resale in Greece: Which Route Wins in 2026?"
...
## How Are Off-Plan and Resale Taxed Differently?
This one line decides most of the cost comparison. A resale attracts 3.09% transfer tax on the higher of contract price or objective value, roughly €15,450 on a €500,000 purchase, with total acquisition costs landing at 7% to 10%. A new-build first sale falls inside the VAT system at 24%, which would be €120,000 on the same price, and is only cheaper than resale while the VAT suspension holds.
...
Both routes need the same legal scaffolding; the risks they carry point in opposite directions. Resale risk is historical: a twenty-year title chain, inherited fractional shares under Greek succession law, ENFIA arrears and permit violations inherited from prior owners. Off-plan risk is prospective: developer solvency, delivery date, specification drift and whether a bank guarantee actually covers your staged payments. One is archaeology, the other is underwriting a counterparty.
...
Resale and off-plan diligence face in opposite directions and cost about the same. A resale file looks backwards: a twenty-year title search at €200 to €500 in lawyer time, a cadastral extract at €50 to €150, ENFIA clearance for the last five years, and an engineer survey at €300 to €800 for an apartment or €500 to €1,500 for a villa, which is where unpermitted works and their regularisation fines of €2,000 to €4,000 surface. An off-plan file looks forwards: the building permit and its date, the developer's corporate solvency and filed accounts, a bank guarantee over each stage payment, and a contractual delivery date with penalties. Greece mandates no developer escrow, so on an €800,000 unit the €440,000 to €680,000 paid before the deed is an unsecured contractual claim unless a guarantee is negotiated.
...
## Which Returns More, Off-Plan or Resale?
...
## Does Off-Plan Work for a Golden Visa?
...
The decision usually turns on timeline rather than on preference. Resale suits buyers who need rental income immediately, want to inspect what they are buying, have low construction-risk appetite, or are working to a visa deadline. Off-plan suits buyers comfortable with an 18 to 36 month horizon, who want new-build specification unavailable in the resale stock, and whose delivery date sits safely inside the VAT suspension window.
...
Four items on this list apply whichever route you take — AFM, Greek bank account, an engaged lawyer and a power of attorney if you will not attend. The rest splits by type: resale diligence looks backwards at title, ENFIA and cadastre history, while off-plan diligence looks forwards at the permit, the developer's solvency and the bank guarantee.
...
**The buyer on a visa timeline.** Resale, without much debate. Off-plan delivery of 18 to 36 months sits before the Golden Visa clock even starts, since the permit follows the deed. If residency is time-sensitive, construction risk is a schedule risk rather than a quality one.

**The buyer who wants income from day one.** Resale again. An off-plan unit produces nothing until handover, and the holding cost during construction is real capital sitting idle.

**The buyer optimising total cost during the VAT suspension.** Off-plan becomes competitive here, provided the deed completes inside the suspension window. Confirm the permit date, verify first-sale status, and put the VAT allocation in writing in the preliminary agreement if completion could slip past December 2026.

## Off-Plan Purchase in Ellinikon vs Resale in Glyfada

| Investment Metric | Option A: Off-Plan (Ellinikon Park) | Option B: Resale (Glyfada Center) |
| --- | --- | --- |
| Deed value | €800,000 | €800,000 |
| Capital needed before the first tenant | None; delivered finished | €50,000 to reach Energy Class B |
| All-in capital | €800,000 | €850,000 |
| Acquisition tax | 3.09% FMA (€24,720) while the VAT suspension holds | 3.09% FMA (€24,720) |
| Payment profile | Staged across roughly 24 months of construction | Full price at the deed |
| Time to first rental euro | About 24 months from signing | 3 to 4 months (works, then letting) |
| Indicative gross yield once let | 4.5 to 5.0% | 4.5 to 5.5% on deed value; 4.2 to 5.2% on all-in capital |
| Golden Visa qualification | Yes, on the deed value at completion | Yes, on the deed value; the €50,000 of works does not count toward the threshold |
| Principal risk | Construction delay, developer insolvency, specification drift | Hidden condition, permit mismatch, renovation overrun |
| Exit liquidity | Untested until the district matures | Established Glyfada resale market |

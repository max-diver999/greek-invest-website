...
The €250,000 is the floor for the qualifying investment, not the budget. A realistic all-in figure is €290,000 to €330,000 once you add transfer tax on the acquisition, engineer and architect fees, the building permit, construction contingency and the professional costs of the file itself. Buyers who treat €250,000 as the price rather than as the threshold run out of money at the point where the works have to be finished for the application to be accepted.
...
## Risks and red flags on the €250,000 route


This tier fails more often than the other two, and almost always for the same reason: the conversion has to be finished, with a habitation certificate issued, before the application is submitted. Buying a commercial unit at €250,000 intending to convert it afterwards qualifies for nothing at all.
This is the cheapest route and the one with the most ways to fail.

- **Conversion must be complete before the application.** The property has to be residential, with a habitation certificate issued, at the point the file is submitted. An unconverted commercial unit bought at €250,000 with a plan to convert later does not qualify.
- **The €250,000 must cover the works.** The threshold is measured on the investment, and the conversion or restoration cost is part of what the Ministry examines. A €150,000 purchase plus €100,000 of unevidenced works is not the same as €250,000 documented.
- **Listed-building constraints.** Heritage restoration is supervised by the archaeological or heritage authority, which controls materials, methods and timetable. Budget a longer programme and a higher cost per square metre than an ordinary renovation.
- **No 120 m² exemption elsewhere.** This route escapes the area rule; the other routes do not. Buyers sometimes carry that exemption across in their heads when comparing options.
